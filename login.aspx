...
<body>
    ...
    <div>        
        ...
        <asp:UpdatePanel ID="UpanelLogin" runat="server" UpdateMode="Conditional">
            <contenttemplate>
                <div>
                    <asp:Panel  CssClass="LuckyIluminado" style=" margin:auto; width:500px; height:400px" ID="PanelLogin" runat="server" DefaultButton="btningreso" ForeColor="Black">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="txtuser" Font-Bold="True"
                                        Font-Names="Verdana" Font-Size="8pt" ForeColor="White" Text="USUARIO"></asp:Label>
                                </td>
                                <td class="fondotextbox">
                                    <asp:TextBox ID="txtuser" runat="server" BackColor="Transparent" BorderStyle="None"
                                        CssClass="textbox" Width="120px" oncopy="return false" onpaste="return false"  oncut="return false"  TextMode="SingleLine"></asp:TextBox>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td style=" float:right">
                                    <asp:Label ID="Label1" runat="server" AssociatedControlID="txtpassw" Font-Bold="True"
                                        Font-Names="Verdana" Font-Size="8pt" ForeColor="White" Text="CLAVE"></asp:Label>
                                </td>
                                <td class="fondotextbox">
                                    <asp:TextBox ID="txtpassw" runat="server" BorderStyle="None" CssClass="textbox" TextMode="Password"
                                        Width="120px" oncopy="return false" onpaste="return false"  oncut="return false"></asp:TextBox>
                                </td>
                                <td>
                        ...
                        <div style=" margin:auto; width:135px">
                            ...
                            <div style=" margin:auto; width:100px">
                                    ...
                                    <asp:Button ID="btningreso" runat="server" CommandName="Login" CssClass="btIngresar" 
                                        Height="55px" OnClick="btningreso_Click" Width="100px" />
