<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu_Planning.aspx.cs"
    Inherits="SIGE.Pages.Modulos.Planning.Menu_Planning" %>
    ...
    <div class="menuplanning">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>             
                ...
                <div align="center" >
        <asp:Label ID="SelModulo" runat="server" Text="Módulo Alternativo" ForeColor="ActiveCaption" Font-Names="Verdana" Font-Size="12px"></asp:Label>
        
            <asp:DropDownList ID="cmbselModulos" runat="server"  Font-Names="Verdana" 
            Font-Size="11px" AutoPostBack="True" 
            onselectedindexchanged="cmbselModulos_SelectedIndexChanged">
            
        </asp:DropDownList>
        
        <asp:Label ID="SelCliente" runat="server" Text="Cliente" ForeColor="ActiveCaption" Font-Names="Verdana" Font-Size="12px"></asp:Label>
        
            <asp:DropDownList ID="cmbcliente" runat="server"  Font-Names="Verdana" Font-Size="11px" Visible = "false">
            
        </asp:DropDownList>
        <asp:Button ID="GO" runat="server" Text="Ir" Font-Size="10px"
              onclick="GO_Click"  Width="26px" />
    </div>
                            ...
                            <asp:Panel ID="PnlMenuPlanning" CssClass="borde_panel" runat="server" BackColor="White" Width="600px">
                                <div align="center">
                                    ...
                                    <table align="center">
                                        <tr>
                                            <td>
                                                <asp:Button ID="BtnSolicitudes" runat="server" Text="Solicitudes" CssClass="buttonPlanSolicitud"
                                                    Width="164px" Height="25px" />
                                            </td>
                                            <td>
                                                <asp:Button ID="BtnInforComun" runat="server" Text="Informes Comunes" CssClass="buttonPlanInfocomun"
                                                    Width="164px" Height="25px" OnClick="BtnInforComun_Click" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Button ID="BtnNuevasCamp" runat="server" Text="Nuevas Campañas" CssClass="buttonNewPlan"
                                                    Width="164px" Height="25px" OnClick="BtnNuevasCamp_Click"   />
                                            </td>
                                            <td>
                                                <asp:Button ID="BtnConsultas" runat="server" Text="Consultar Campañas" CssClass="buttonPlanConsultaCam"
                                                    Width="164px" Height="25px" OnClick="BtnConsultas_Click" visible ="true" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                            ...
                            <td bgcolor="#28377d" valign="top">
                                <asp:Panel ID="PSolicitudes" runat="server" Width="593px" Height="397px">
                                    ...
                                    <table align="center">
                                        <tr>
                                            <td>
                                                <asp:Image ID="ImgMail" runat="server" Height="52px" ImageUrl="~/Pages/images/mailreminder.png"
                                                    Width="65px" />
                                            </td>
                                            <td align="center">
                                    ...
                                    <table align="center">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="TxtSolicitante" runat="server" Enabled="False" Width="400px" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td valign="top">
                                            ...
                                            <td>
                                                <asp:TextBox ID="TxtEmail" runat="server" Enabled="False" Width="400px" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td valign="top">
