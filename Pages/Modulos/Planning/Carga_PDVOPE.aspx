            ...
            <ContentTemplate>
                <div>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="LblTitCargarArchivo" runat="server" CssClass="labels" 
                                    Text="Cargar nuevo archivo de asignación de rutas"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <br />
                    ...
                    <table align="center" style="display: none;">
                        <tr>
                            <td>
                                <asp:DropDownList ID="CbmPDV" runat="server"></asp:DropDownList>
                                <asp:DropDownList ID="CmbOpePlanning" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                        <table align="center">
                            <tr>
                    ...
                    <table align="center">
                        <tr>
                            ...
                            <td style="width: 238px; height: 119px;" valign="top"><br />
                                <asp:Label ID="lblencabezado" runat="server" CssClass="labels"></asp:Label><br /><br />
