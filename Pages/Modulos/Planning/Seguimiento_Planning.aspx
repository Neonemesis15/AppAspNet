<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Seguimiento_Planning.aspx.cs"
    Inherits="SIGE.Pages.Modulos.Planning.Seguimiento_Planning" %>
...
<body onkeypress="return pulsar(event)">
    ...
    <asp:UpdatePanel ID="UpPlanning" runat="server">
        <ContentTemplate>
                    ...
                    <ContentTemplate>
                                        ...
                                        <asp:UpdateProgress ID="UpdateProg1" DisplayAfter="0" runat="server">
                                            <ProgressTemplate>
                                                <div style="text-align: center;">
                                                    ...
                                                    <asp:Label ID="lblProgress" runat="server" Text=" Procesando, por favor espere ..." ForeColor="Black"></asp:Label>
                                                </div>
                                            </ProgressTemplate>
                                        </asp:UpdateProgress>
                                    </asp:Panel>
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td align="center" background="../../images/tablas_genericas/bg_gris_tablasgene.jpg"> <img height="6" src="../../images/tablas_genericas/bordegris_tablasgene_inf1.png" width="1"> </img>  </td>
                                    ...
                                    <tr>
                                        ...
                                        <td bgcolor="White">
                                            <asp:Panel ID="PanelPDVOpe" runat="server" Style="vertical-align: middle;">
                                                <div>
                                                    <asp:ImageButton ID="ImgCloseAsignacionPDVaoper" runat="server" AlternateText="Cerrar Ventana"
                                                        ToolTip="Cerrar Ventana" BackColor="Transparent" Height="22px" ImageAlign="Right"
                                                        ImageUrl="~/Pages/ImgBooom/salir.png" Width="23px" OnClick="BtnCOlv_Click" />
                                                </div>
                                                <table align="center">
                                                                        ...
                                                                        <table>
                                                                            <tr>
                                                                                <td valign="top" style="border-color: Black; height: 70px; border-style: solid; border-width: 1px;
                                                                                    ...
                                                                                    <asp:Button ID="Button1" runat="server" CssClass="buttonPlan" OnClick="Button1_Click"
                                                                                        Text="Eliminar" Visible="false" />
                                                                                    <asp:Button ID="BtnAllAsigPDV" runat="server" Visible="false" CssClass="buttonsinfondo"
                                                                                        Text="Todos" OnClick="BtnAllAsigPDV_Click" />
                                                                                    <asp:Button ID="BtnNoneasigPDV" runat="server" Visible="false" CssClass="buttonsinfondo"
                                                                                        Text="Ninguno" OnClick="BtnNoneasigPDV_Click" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </fieldset>
                                                    ...
                                                    <ContentTemplate>
                                                        <table align="center">
                                                            <tr>
                                                                        ...
                                                                        <table align="center">
                                                                            ...
                                                                            <tr>
                                                                                <td valign="top" style="border-color: Black; border-style: solid; border-width: 1px;
                                                                                    width: 475px; min-width: 475px; height: 70px;">
                                                                                    <asp:CheckBoxList ID="ChkListPDV" runat="server" CssClass="ScrollPersonalPlanning"
                                                                                        Font-Names="Verdana" Font-Size="8pt" RepeatLayout="Flow" Width="475px" Enabled="False"
                                                                                        Height="70px">
                                                                                    </asp:CheckBoxList>
                                                                                </td>
                                                                            </tr>
                                                                ...
                                                                <td>
                                                                    <asp:Button ID="BtnAsigPDVOPE" runat="server" CssClass="pagnext" Text=" ." ToolTip="Asignar"
                                                                        Width="25px" Enabled="False" OnClick="BtnAsigPDVOPE_Click" />
                                                                </td>
                                                                <td>
                                                                    <fieldset id="Fieldset5" runat="server">
                                                                        ...
                                                                        <table>
                                                                            <tr>
                                                                                <td valign="top" style="border-color: Black; height: 201px; border-style: solid;
                                                                                    border-width: 1px; width: 570px; min-width: 570px;">
                                                                                    <div style="width: 570px; height: 190px;" class="p">
                                                                                        <asp:GridView ID="GvNewAsignaPDVOPE" runat="server" EmptyDataText="No se ha realizado ninguna asignación"
                                                                                            Font-Names="Verdana" Font-Size="8pt" GridLines="Horizontal" Width="555px" OnSelectedIndexChanged="GvNewAsignaPDVOPE_SelectedIndexChanged">
                                                                                            <Columns>
                                                                                                <asp:CommandField ButtonType="Image" SelectImageUrl="~/Pages/images/delete.png" SelectText=""
                                                                                                    ShowSelectButton="True" />
                                                                                            </Columns>
            ...
            <div class="footer" style="width: 100%; left: 0px;">
                <br />
                <br />
                <br />
