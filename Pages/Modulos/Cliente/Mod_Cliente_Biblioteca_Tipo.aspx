<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mod_Cliente_Biblioteca_Tipo.aspx.cs" 
    Inherits="SIGE.Pages.Modulos.Cliente.Mod_Cliente_Biblioteca_Tipo" %>
        ...
        <tr>
            <td valign="top">
                <div>
                    <ul id="mycarousel" class="jcarousel jcarousel-skin-tango">
                        <asp:ListView runat="server" ID="ListViewMateriales" DataKeyNames="idtipoMa" OnSelectedIndexChanged="ListViewMateriales_SelectedIndexChanged"
                            OnPagePropertiesChanging="ListViewMateriales_PagePropertiesChanging" OnSelectedIndexChanging="ListViewMateriales_SelectedIndexChanging">
                            <LayoutTemplate>
                                <li runat="server" id="itemPlaceholder"></li>
                            </LayoutTemplate>
                            <ItemTemplate>
                                <li id="Tr1" runat="server" class="listviewcateg">
                                    <asp:Label ID="idtipoMa" runat="server" Text='<%#Eval("idtipoMa") %>' Visible="false" />
                                    <asp:Label ID="TipoMaDescripcion" runat="server" Text='<%#Eval("TipoMaDescripcion") %>'
                                        Visible="false" />
                                    <asp:LinkButton runat="server" ID="Button1" Text='<%#Eval("TipoMaDescripcion") %>'
                                        CommandName="Select" Height="80px" Width="100px" CssClass="centradotext" Font-Underline="False" />
                                </li>
                            </ItemTemplate>
                        </asp:ListView>
                    </ul>
            ...
            <td valign="top" height="300px">
                <asp:UpdatePanel ID="uppanel" runat="server">
                                    ...
                                    <td valign="top" style="width: 0px; height: 90%; max-height: 90%;">
                                        <div style="max-height: 200px; overflow: auto; display: none; background-color: Transparent;"
                                            ...
                                            <asp:Menu ID="MenuMarcas" runat="server" CssSelectorClass="menu" Orientation="Vertical"
                                                OnMenuItemClick="MenuMarcas_MenuItemClick" StaticDisplayLevels="3" Width="100%" Visible="false">
                                            </asp:Menu>
                                        </div>
                                        <br />
                                        <div style="max-height: 200px; overflow: auto; display: none; background-color: Transparent;"
                                            ...
                                            <asp:ListView ID="ListViewBiblioteca" runat="server" GroupItemCount="3" DataKeyNames="Ruta_URL"
                                                ...
                                                <ItemTemplate>
                                                    <td id="Td2" runat="server" align="center" valign="top">
                                                        <div id="caja1" align="center" style="width: 200px; height: 152px; background-image: url('../../ImgBooom/filtrodefoto.png');">
                                                ...
                                                <LayoutTemplate>
                                                    <table id="Table2" align="center" runat="server">
                                                        <tr id="Tr2" runat="server" align="center">    
                                                            <td id="Td3" runat="server" valign="top" align="center" >
                                                                <table align="center" id="groupPlaceholderContainer" runat="server" border="0" style="">
                                                ...
                                                <GroupTemplate>
                                                    <tr id="itemPlaceholderContainer" runat="server" align="center">
                                                ...
                                                <SelectedItemTemplate>
                                                    <td id="Td2" runat="server" align="center" valign="top">
                                                        ...
                                                        <table align="center">
                                                            <tr align="center">
                                                                <td align="center" valign="middle">
                                                                    <div class="labelBiblioteca" align="center">
                                                                        <asp:Label ID="infoPOPClientPhotos_nameLabel" runat="server" Text='<%# Eval("infoPOPClientPhotos_name") %>' />
                                                                    </div>
                                                                </td>
                                                            </tr>
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="ListViewMateriales" EventName="SelectedIndexChanged" />
                    </Triggers>
                </asp:UpdatePanel> 
            </td> 
