<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mod_ClienteV2.aspx.cs" Inherits="SIGE.Pages.Modulos.Cliente.Mod_ClienteV2" %>
...
<body>
    ...
    <div class="Header">
        <asp:Image ID="Image3" runat="server" ImageUrl="~/Pages/ImgBooom/logotipo.png"></asp:Image>
        <br />
        <br />
        <br />
    </div>
    ...
    <ContentTemplate>
    <asp:Panel ID="PanelClienteReportes" runat="server" CssClass="DetalleInformes">
        <div id="CarrosTabla" class="tamañocarrusel" style="margin-left: auto; margin-right: auto;
            width: 821px; border: 0px solid #000;">
    ...
    <%-- <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>--%>
        <asp:UpdatePanel ID="upcanales" runat="server"><ContentTemplate>
    <asp:Panel ID="Panel" runat="server">
        <div align="center" class="DetalleCanales">
    ...
    <div class="wrapper" align="center" style="display: none;">
    </div>
    <div class="push">
    </div>
