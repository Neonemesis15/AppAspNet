...
//                        T += '<li data-index="' + ah + '">' + (ah + 1) + "</li>"
    ...
    a.fn.ccslider.defaults = {
        ...
        //effect: "cubeUp", modificar para cambiar de 2d a 3d, modificar el effectType, y el effect (3d redimensiona automaticamente las imagenes, 2d se debe cambiar el tamaño de las imagenes)
        _3dOptions: {
            imageWidth: 600,
            imageHeight: 300,
            innerSideColor: "#444",
