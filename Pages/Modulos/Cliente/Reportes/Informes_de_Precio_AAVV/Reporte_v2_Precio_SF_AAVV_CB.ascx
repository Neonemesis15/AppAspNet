<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Reporte_v2_Precio_SF_AAVV_CB.ascx.cs" Inherits="SIGE.Pages.Modulos.Cliente.Reporte_v2_Precio_SF_AAVV_CB" %>
<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"
    ...
    <ContentTemplate>
          ...
          <rsweb:ReportViewer ID="ReportPrecio" runat="server" Font-Names="Verdana" 
