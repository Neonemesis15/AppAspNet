<%@ Page Language="C#" MasterPageFile="~/Pages/Modulos/Cliente/Reportes/MasterPageV2/design/MasterPage.master"
    AutoEventWireup="true" CodeBehind="Reporte_v2_PresenciaColgate_40Mandatory_FarmDT.aspx.cs"
    Inherits="SIGE.Pages.Modulos.Cliente.Reportes.Reporte_v2_PresenciaColgate_40Mandatory_FarmDT" %>
        ...
        <telerik:RadPane ID="RadPane_contenidoReportes" runat="server">
            <div>
                <asp:UpdatePanel ID="up_report" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <rsweb:ReportViewer ID="ReportMandatory" runat="server" Font-Names="Verdana" Font-Size="8pt"
