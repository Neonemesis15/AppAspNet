...
{
    public partial class Reporte_v2_Sugerido_Producto_3M : System.Web.UI.Page
    {
        ...
        private void ObtenerInformeSug_Producto()
        {
            ...
            try
            {
                ...
                ReporSugProducto.Visible = true;
                ReporSugProducto.ZoomMode = Microsoft.Reporting.WebForms.ZoomMode.FullPage;
                ReporSugProducto.ServerReport.ReportPath = "/Reporte_Precios_V1/Reporte_Pedidos_3M";


                String strConnection = ConfigurationManager.AppSettings["SERVIDOR_REPORTING_SERVICES"];

                ReporSugProducto.ServerReport.ReportServerUrl = new Uri(strConnection);
                ReporSugProducto.ServerReport.ReportServerCredentials = new CFG.Tools.ReportServerNetCredentials();
                ...
                ReporSugProducto.ServerReport.SetParameters(parametros);
            }
            catch (Exception ex)
            {
