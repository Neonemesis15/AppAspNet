...
<%-- <div   align="center"  style="background-color:Blue;"> --%>
    <%-- <asp:Button ID="btn_consultar0" runat="server" CssClass="buttonEditPlan" Height="24px" Text="Consultar" Width="160px" 
            onclick="btn_consultar0_Click" Visible="false" /> --%>  
<%-- </div> --%>

<asp:UpdatePanel ID= "reporprecio" runat="server">
    <ContentTemplate>
        <rsweb:ReportViewer ID="reportinPrecios" runat="server" Font-Size="8pt" ProcessingMode="Remote" ShowParameterPrompts="False" 
            ToolTip="Panel de Precios" style="width:auto;" SizeToReportContent="True" ZoomMode="Percent" ShowZoomControl="true" 
            Visible="False">
        </rsweb:ReportViewer>
    </ContentTemplate>
 </asp:UpdatePanel>
