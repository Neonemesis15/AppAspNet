...
namespace SIGE.Pages.Modulos.Cliente.Reportes.Informes_de_Precio
{
    public partial class Reporte_v2_Precio_InformePrecioAASSCad : System.Web.UI.UserControl
    {
        //string canal;
        //int icompanyid;
        //string sciudad;
        ...
        //    reportinPrecios.Visible = true;
        //    reportinPrecios.ZoomMode = Microsoft.Reporting.WebForms.ZoomMode.FullPage;
        //    reportinPrecios.ServerReport.ReportPath = "/Reporte_Precios_V1/Informe_de_Precios";


        //    String strConnection = ConfigurationSettings.AppSettings["SERVIDOR_REPORTING_SERVICES"];
        //    reportinPrecios.ServerReport.ReportServerUrl = new Uri(strConnection);
        ...
        //    reportinPrecios.ServerReport.SetParameters(parametros);
