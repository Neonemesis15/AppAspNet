...
{
    public partial class Reporte_v2_PresenciaColgate_ES_IT : System.Web.UI.Page
    {
        ...
        private void cargarReportES()
        {
            ...
            Report_ES_IT.Visible = true;

            Report_ES_IT.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            Report_ES_IT.ZoomMode = Microsoft.Reporting.WebForms.ZoomMode.Percent;
            Report_ES_IT.ServerReport.ReportPath = "/Reporte_Precios_V1/Reporte_PresenciaITColgateGraficos";

            String strConnection = ConfigurationManager.AppSettings["SERVIDOR_REPORTING_SERVICES"];

            Report_ES_IT.ServerReport.ReportServerUrl = new Uri(strConnection);
            Report_ES_IT.ServerReport.ReportServerCredentials = new CFG.Tools.ReportServerNetCredentials();
            ...
            parametros.Add(new Microsoft.Reporting.WebForms.ReportParameter("COBERTURA", "0"));// siempre se pasa en 0


            Report_ES_IT.ServerReport.SetParameters(parametros);
        }
