...
{
    public partial class Reporte_v2_Pedido_3M : System.Web.UI.Page
    {
        ...
        private void GenerarReportePedido()
        {
            ...
            try
            {
                repordet = (ReportViewer)(Reporte_v2_Pedido_3M1.FindControl("ReportPedido"));
                repordet.Visible = true;
                repordet.ZoomMode = Microsoft.Reporting.WebForms.ZoomMode.FullPage;
                repordet.ServerReport.ReportPath = "/Reporte_Precios_V1/Reporte_PEDIDO_3M";
                ...
                parametros.Add(new Microsoft.Reporting.WebForms.ReportParameter("SEMANA", ssemana));
                parametros.Add(new Microsoft.Reporting.WebForms.ReportParameter("POINTOFSALE", spointofsale));
        ...
        private void _AsignarVariables()
        {
            ...
            ssemana = cmb_Semana.SelectedValue;
            sfamilia = cmb_Familia.SelectedValue;
