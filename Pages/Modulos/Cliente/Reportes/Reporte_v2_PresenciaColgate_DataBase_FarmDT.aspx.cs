...
{
    public partial class Reporte_v2_PresenciaColgate_DataBase_FarmDT : System.Web.UI.Page
    {
        ...
        private void cargarReportDB()
        {
            ...
            ReportDB.Visible = true;

            ReportDB.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            ReportDB.ZoomMode = Microsoft.Reporting.WebForms.ZoomMode.Percent;
            ReportDB.ServerReport.ReportPath = "/Reporte_Precios_V1/Reporte_Presencia_DB_FarmDT";

            String strConnection = ConfigurationManager.AppSettings["SERVIDOR_REPORTING_SERVICES"];

            ReportDB.ServerReport.ReportServerUrl = new Uri(strConnection);
            ReportDB.ServerReport.ReportServerCredentials = new CFG.Tools.ReportServerNetCredentials();
            ...
            ReportDB.ServerReport.SetParameters(parametros);
        }
