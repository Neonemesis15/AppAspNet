<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Modulos/Cliente/Reportes/MasterPageV2/design/MasterPage.master" AutoEventWireup="true" CodeBehind="Reporte_v2_Precios_3M.aspx.cs" Inherits="SIGE.Pages.Modulos.Cliente.Reportes.Reporte_v2_Precios_3M" %>
                        ...
                        <ContentTemplate>
                            <table style="width: auto; height: auto;" align="center" class="art-Block-body">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <telerik:RadComboBox ID="cmb_categoria" runat="server" AutoPostBack="true"
                        ...
                        <ContentTemplate>
                            <div id="div_parametro" align="left">
                                ...
                                <telerik:RadGrid ID="RadGrid_parametros" runat="server" AutoGenerateColumns="False"
                                    GridLines="None"  Skin="" OnItemCommand="RadGrid_parametros_ItemCommand" >
                                    <MasterTableView>
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn UniqueName="TemplateColumn">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lbl_Id_producto_categoria" runat="server" Visible="False" Text='<%# Bind("Id_producto_categoria") %>'></asp:Label>
                                                    <asp:Label ID="lbl_Id_producto_familia" runat="server" Visible="False" Text='<%# Bind("Id_producto_familia") %>'></asp:Label>
                                                    <asp:Label ID="lbl_Id_Semana" runat="server" Visible="False" Text='<%# Bind("Id_Semana") %>'></asp:Label>
...
<ContentTemplate>
                            <uc2:Reporte_v2_Precio_InformePrecio_3M ID="Reporte_v2_Precio_InformePrecio_3M1" runat="server" />
