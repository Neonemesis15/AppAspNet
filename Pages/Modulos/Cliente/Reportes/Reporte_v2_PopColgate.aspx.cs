...
{
    public partial class Reporte_v2_PopColgate : System.Web.UI.Page
    {
        ...
        public void llenargrilla1(string NodeComercial, string Company)
        {
            ...
            ds = cn.ejecutarDataSet("UP_WEBXPLORA_CLIE_V2_REPORTE_POP_COLGATE", NodeComercial, canal, iservicio, icompany, cmb_año.SelectedValue, cmb_mes.SelectedValue, cmb_periodo.SelectedValue);
        ...
        public void grabarimg(string nombre, byte[] byteArrayIn)
        {
            ...
            fc = File.Create(Server.MapPath("Colgate_POP" + nombre + ".Png"));
            fc.Write(byteArrayIn, 0, byteArrayIn.Length);
            fc.Flush();
            fc.Close();

            imag.Src = ("Colgate_POP" + nombre + ".Png");

            link.HRef = ("Colgate_POP" + nombre + ".Png");
        }
    }
}