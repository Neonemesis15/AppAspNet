<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Modulos/Cliente/Reportes/MasterPageV2/design/MasterPage.master"
 AutoEventWireup="true" CodeBehind="Reporte_v2_Exhibiciones_Adicionales_3M.aspx.cs" Inherits="SIGE.Pages.Modulos.Cliente.Reportes.Reporte_v2_Exhibiciones_Adicionales_3M" %>
        ...
        <ContentTemplate>
            ...
            <div id="Titulo_reporte_Efectividad" style="text-align: left;">
                <div style="text-align: center; font-family: Verdana; font-style: normal; font-size: large;
                    color: #D01887;">
                    REPORTE EXHIBICIONES ADICIONALES</div>
            </div>
                    ...
                    <asp:TabPanel ID="TabFiltros" runat="server" HeaderText="TabPanel1">
                       ...
                       <telerik:RadComboBox ID="cmb_año" runat="server" Width="238px" Skin="Vista">
                        ...
                        <telerik:RadComboBox ID="cmb_categoria" runat="server" Width="238px" Skin="Vista" 
                          ...
                          <td>
                         <telerik:RadComboBox ID="cmb_tienda" runat="server" Width="238px" Skin="Vista">
                                            </telerik:RadComboBox>
                        </td>
                        </tr>
                        <tr>
                        ...
                        <ContentTemplate>
                            <div>
                                <asp:UpdatePanel ID="upquiebre" runat="server">
                                    <ContentTemplate>
                                        <rsweb:ReportViewer ID="ReporExhAdi" runat="server" Font-Names="Verdana" Font-Size="8pt"
