...
{
    public partial class Reporte_v2_PresenciaColgate_Princing_FarmDT : System.Web.UI.Page
    {
        ...
        private void cargarReportPricing()
        {
            RadComboBox cmb_periodo = RadPanelBar_menu.FindChildByValue<RadPanelItem>("filtro").FindControl("cmb_periodo") as RadComboBox;
            RadComboBox cmb_año = RadPanelBar_menu.FindChildByValue<RadPanelItem>("filtro").FindControl("cmb_año") as RadComboBox;
            RadComboBox cmb_mes = RadPanelBar_menu.FindChildByValue<RadPanelItem>("filtro").FindControl("cmb_mes") as RadComboBox;
            ...
            ReportPricing.Visible = true;

            ReportPricing.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            ReportPricing.ZoomMode = Microsoft.Reporting.WebForms.ZoomMode.Percent;
            ReportPricing.ServerReport.ReportPath = "/Reporte_Precios_V1/Reporte_Presencia_Price_FarmDT";

            String strConnection = ConfigurationManager.AppSettings["SERVIDOR_REPORTING_SERVICES"];

            ReportPricing.ServerReport.ReportServerUrl = new Uri(strConnection);
            ReportPricing.ServerReport.ReportServerCredentials = new CFG.Tools.ReportServerNetCredentials();
            ...
            parametros.Add(new Microsoft.Reporting.WebForms.ReportParameter("CATEGORIA", (id_categoria==null?"9993":id_categoria)));
            ...
            ReportPricing.ServerReport.SetParameters(parametros);
        }
