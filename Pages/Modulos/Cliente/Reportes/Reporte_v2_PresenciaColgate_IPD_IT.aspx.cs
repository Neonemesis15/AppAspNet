...
{
    public partial class Reporte_v2_PresenciaColgate_IPD_IT : System.Web.UI.Page
    {
        ...
        private void cargarReportIndexPriceDatail()
        {
            RadComboBox cmb_periodo = RadPanelBar_menu.FindChildByValue<RadPanelItem>("filtro").FindControl("cmb_periodo") as RadComboBox;
            RadComboBox cmb_año = RadPanelBar_menu.FindChildByValue<RadPanelItem>("filtro").FindControl("cmb_año") as RadComboBox;
            RadComboBox cmb_mes = RadPanelBar_menu.FindChildByValue<RadPanelItem>("filtro").FindControl("cmb_mes") as RadComboBox;
            ...
            ReportIndexPriceDatail.Visible = true;

            ReportIndexPriceDatail.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            ReportIndexPriceDatail.ZoomMode = Microsoft.Reporting.WebForms.ZoomMode.Percent;
            ReportIndexPriceDatail.ServerReport.ReportPath = "/Reporte_Precios_V1/Reporte_IndexPriceDetail_IT";

            String strConnection = ConfigurationManager.AppSettings["SERVIDOR_REPORTING_SERVICES"];

            ReportIndexPriceDatail.ServerReport.ReportServerUrl = new Uri(strConnection);
            ReportIndexPriceDatail.ServerReport.ReportServerCredentials = new CFG.Tools.ReportServerNetCredentials();
            ...
            ReportIndexPriceDatail.ServerReport.SetParameters(parametros);
        }
