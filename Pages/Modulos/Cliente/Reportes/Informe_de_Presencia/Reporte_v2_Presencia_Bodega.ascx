<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Reporte_v2_Presencia_Bodega.ascx.cs" Inherits="SIGE.Pages.Modulos.Cliente.Reportes.Informe_de_Presencia.Reporte_v2_Presencia_Bodega" %>
<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"
    Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>
     ...
     <asp:Button ID="Btndisparaalertas" runat="server" CssClass="alertas" Text="" Visible="true"
                Width="0px" />
<asp:UpdatePanel ID="upPB" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
    <ContentTemplate>
        <rsweb:ReportViewer ID="ReportPresenciaBodega" runat="server" Font-Names="Verdana" Font-Size="8pt"
