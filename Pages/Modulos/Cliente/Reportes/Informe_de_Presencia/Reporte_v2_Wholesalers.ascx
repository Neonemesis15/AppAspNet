<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Reporte_v2_Wholesalers.ascx.cs" Inherits="SIGE.Pages.Modulos.Cliente.Reportes.Informe_de_Presencia.Reporte_v2_Wholesalers" %>
...
<asp:UpdatePanel ID="upWS" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
    <ContentTemplate>
        <rsweb:ReportViewer ID="ReportWholessalersGrafics" runat="server" Font-Names="Verdana"
