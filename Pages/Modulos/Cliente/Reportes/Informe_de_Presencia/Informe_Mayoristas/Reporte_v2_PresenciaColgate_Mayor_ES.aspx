<%@ Page Language="C#" MasterPageFile="~/Pages/Modulos/Cliente/Reportes/MasterPageV2/design/MasterPage.master"
    AutoEventWireup="true" CodeBehind="Reporte_v2_PresenciaColgate_Mayor_ES.aspx.cs"
    Inherits="SIGE.Pages.Modulos.Cliente.Reportes.Informe_de_Presencia.Informe_Mayoristas.Reporte_v2_PresenciaColgate_Mayor_ES" %>
            ...
            <telerik:RadPanelBar ID="RadPanelBar_menu" runat="server" ExpandMode="FullExpandedItem"
                ...
                <Items>
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:UpdatePanel ID="up_saveConsulta" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <asp:Button ID="btn_disparrar" runat="server" CssClass="alertas" Text="ocultar"
                                                Width="95px" />
                    ...
                    <telerik:RadPanelItem runat="server" 
                        NavigateUrl="~/Pages/Modulos/Cliente/Reportes/Informe_de_Presencia/Reporte_v2_PresenciaConfiguracion.aspx" 
