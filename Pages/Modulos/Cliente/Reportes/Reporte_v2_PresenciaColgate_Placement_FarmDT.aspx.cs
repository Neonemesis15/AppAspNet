...
{
    public partial class Reporte_v2_PresenciaColgate_Placement_FarmDT : System.Web.UI.Page
    {
        ...
        private void cargarReportPlacement()
        {
            RadComboBox cmb_periodo = RadPanelBar_menu.FindChildByValue<RadPanelItem>("filtro").FindControl("cmb_periodo") as RadComboBox;
            RadComboBox cmb_año = RadPanelBar_menu.FindChildByValue<RadPanelItem>("filtro").FindControl("cmb_año") as RadComboBox;
            RadComboBox cmb_mes = RadPanelBar_menu.FindChildByValue<RadPanelItem>("filtro").FindControl("cmb_mes") as RadComboBox;
            ...
            ReportPlacement.Visible = true;

            ReportPlacement.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            ReportPlacement.ZoomMode = Microsoft.Reporting.WebForms.ZoomMode.Percent;
            ReportPlacement.ServerReport.ReportPath = "/Reporte_Precios_V1/Reporte_Presencia_ElemetVisivilidad_FarmDT";

            String strConnection = ConfigurationManager.AppSettings["SERVIDOR_REPORTING_SERVICES"];

            ReportPlacement.ServerReport.ReportServerUrl = new Uri(strConnection);
            ReportPlacement.ServerReport.ReportServerCredentials = new CFG.Tools.ReportServerNetCredentials();
            ...
            ReportPlacement.ServerReport.SetParameters(parametros);
        }
