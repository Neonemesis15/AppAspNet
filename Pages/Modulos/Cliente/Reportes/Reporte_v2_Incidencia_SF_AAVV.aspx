<%@ Page Language="C#" MasterPageFile="~/Pages/Modulos/Cliente/Reportes/MasterPageV2/design/MasterPage.master"
    AutoEventWireup="true" CodeBehind="Reporte_v2_Incidencia_SF_AAVV.aspx.cs" Inherits="SIGE.Pages.Modulos.Cliente.Reportes.Reporte_v2_Incidencia_SF_AAVV" %>
...
<asp:Content ID="SheetContent" ContentPlaceHolderID="SheetContentPlaceHolder" runat="Server">
                    ...
                    <div id="Div_filtros" runat="server" align="center" style="width: auto;" visible="true">
                        <asp:TabContainer ID="TabContainer_filtros" runat="server" ActiveTabIndex="0" CssClass="cyan">
                            <asp:TabPanel ID="TabFiltros" runat="server" HeaderText="TabPanel1">
                                ...
                                <ContentTemplate>
                                    <asp:UpdatePanel ID="UpFiltrosIncidencias" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <cc2:ModalUpdateProgress ID="ModalUpdateProgress1" runat="server" DisplayAfter="3" AssociatedUpdatePanelID="UpFiltrosIncidencias"
    ...
    <div id="div_rportes" runat="server" align="center">
        <asp:TabContainer ID="TabContainer_Reporte_Pedido_AAVV" runat="server" Style="width: auto"
            CssClass="magenta" ScrollBars="Both">
            <%--ActiveTabIndex="0"--%>
            <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel15" Style="width: auto;">
                <HeaderTemplate>
                    Mapa Concep.
                    <%--Totales--%>
                </HeaderTemplate>
                <ContentTemplate>
                    ...
                    <rsweb:ReportViewer ID="rpt_incidencia_MapConcep" runat="server" Font-Names="Verdana" Font-Size="8pt"
                        ProcessingMode="Remote" Style="width: auto" ShowParameterPrompts="False"
            ...
            <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel2" Style="width: auto;">
                ...
                <ContentTemplate>
                    <%--<art:Reporte_v2_Precio_SF_AAVV_DET ID="Reporte_v2_Precio_SF_AAVV_DET" runat="server" />--%>
                    <rsweb:ReportViewer ID="rpt_incidencia_tot" runat="server" Font-Names="Verdana" Font-Size="8pt"
            ...
            <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1" Style="width: auto;">
                ...
                <ContentTemplate>
                    <%--<art:Reporte_v2_Precio_SF_AAVV_DET ID="Reporte_v2_Precio_SF_AAVV_DET" runat="server" />--%>
                    <rsweb:ReportViewer ID="rpt_incidencia_sub" runat="server" Font-Names="Verdana" Font-Size="8pt"
                        ProcessingMode="Remote" Style="width: auto" ShowParameterPrompts="False" ToolTip="Comparativo"
                        SizeToReportContent="True" ZoomMode="FullPage" Visible="False">
                    </rsweb:ReportViewer>
                </ContentTemplate>
            ...
            <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel9">
                ...
                <ContentTemplate>
                    ...
                    <rsweb:ReportViewer ID="rpt_incidencia_dist" runat="server" Font-Names="Verdana"
            ...
            <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel14">
                <HeaderTemplate>
                    Dist(Pro/Ser)
                    <%--Distrib (Prod/Serv)--%>
                </HeaderTemplate>
                <ContentTemplate>
                    <rsweb:ReportViewer ID="rpt_incidencia_distps" runat="server" Font-Names="Verdana"
                        Font-Size="8pt" ProcessingMode="Remote" Style="width: auto" ShowParameterPrompts="False"
                        ToolTip="Comparativo" SizeToReportContent="True" ZoomMode="FullPage" Visible="False">
                    </rsweb:ReportViewer>
                </ContentTemplate>
            ...
            <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel5">
                ...
                <ContentTemplate>
                    <%--<art:Reporte_v2_Precio_SF_AAVV_CB ID="Reporte_v2_Precio_SF_AAVV_CB" runat="server" />--%>
                    <rsweb:ReportViewer ID="rpt_incidencia_clie" runat="server" Font-Names="Verdana"
                        Font-Size="8pt" ProcessingMode="Remote" Style="width: auto" ShowParameterPrompts="False"
                        ToolTip="Comparativo" SizeToReportContent="True" ZoomMode="FullPage" Visible="False">
                    </rsweb:ReportViewer>
                </ContentTemplate>
            ...
            <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel4">
                <HeaderTemplate>
                    Detalle Distrib.
                    <%--Incid. Distrib(Prod/Serv) Se modifica el nombre 26/04/2012 Dist(Prod/Serv) PSA--%>
                </HeaderTemplate>
                <ContentTemplate>
                    <%--<art:Reporte_v2_Precio_SF_AAVV_CB ID="Reporte_v2_Precio_SF_AAVV_CB" runat="server" />--%>
                    <rsweb:ReportViewer ID="rpt_incidencia_clieps" runat="server" Font-Names="Verdana"
                        Font-Size="8pt" ProcessingMode="Remote" Style="width: auto" ShowParameterPrompts="False"
                        ToolTip="Comparativo" SizeToReportContent="True" ZoomMode="FullPage" Visible="False">
                    </rsweb:ReportViewer>
                </ContentTemplate>
            ...
            <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel3">
                ...
                <ContentTemplate>
                    <%--<art:Reporte_v2_Precio_SF_AAVV_CB ID="Reporte_v2_Precio_SF_AAVV_CB" runat="server" />--%>
                    <rsweb:ReportViewer ID="rpt_incidencia_zona" runat="server" Font-Names="Verdana"
                        Font-Size="8pt" ProcessingMode="Remote" Style="width: auto" ShowParameterPrompts="False"
                        ToolTip="Comparativo" SizeToReportContent="True" ZoomMode="FullPage" Visible="False">
                    </rsweb:ReportViewer>
                </ContentTemplate>
            </asp:TabPanel>
           <%-- <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel12">
                <HeaderTemplate>
                    Zonas--%>
                    <%--Incid. Zonas--%>
                <%--</HeaderTemplate>
                <ContentTemplate>--%>
                    <%--<art:Reporte_v2_Precio_SF_AAVV_CB ID="Reporte_v2_Precio_SF_AAVV_CB" runat="server" />--%>
                   <%-- <rsweb:ReportViewer ID="rpt_incidencia_tzonasf" runat="server" Font-Names="Verdana"
                        Font-Size="8pt" ProcessingMode="Remote" Style="width: auto" ShowParameterPrompts="False"
                        ToolTip="Comparativo" SizeToReportContent="True" ZoomMode="FullPage" Visible="False">
                    </rsweb:ReportViewer>
                </ContentTemplate>
            </asp:TabPanel>--%>
            <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel13">
                <HeaderTemplate>
                    Zonas(Prod/Serv)
                    <%--Incid. Zonas(Prod/Serv)--%>
                </HeaderTemplate>
                <ContentTemplate>
                    <%--<art:Reporte_v2_Precio_SF_AAVV_CB ID="Reporte_v2_Precio_SF_AAVV_CB" runat="server" />--%>
                    <rsweb:ReportViewer ID="rpt_incidencia_zonaps" runat="server" Font-Names="Verdana"
                        Font-Size="8pt" ProcessingMode="Remote" Style="width: auto" ShowParameterPrompts="False"
                        ToolTip="Comparativo" SizeToReportContent="True" ZoomMode="FullPage" Visible="False">
                    </rsweb:ReportViewer>
                </ContentTemplate>
            </asp:TabPanel>
            <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel8">
                <HeaderTemplate>
                    Cuad.Nivel
                </HeaderTemplate>
                <ContentTemplate>
                    <%--<art:Reporte_v2_Precio_SF_AAVV_CB ID="Reporte_v2_Precio_SF_AAVV_CB" runat="server" />--%>
                    <rsweb:ReportViewer ID="rpt_incidencia_nivelres" runat="server" Font-Names="Verdana"
                        Font-Size="8pt" ProcessingMode="Remote" Style="width: auto" ShowParameterPrompts="False"
                        ToolTip="Comparativo" SizeToReportContent="True" ZoomMode="FullPage" Visible="False">
                    </rsweb:ReportViewer>
                </ContentTemplate>
            </asp:TabPanel>
            <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel10">
                <HeaderTemplate>
                    Nivel Incid.
                    <%--Niveles Se Actualiza el Nombre 26/04/2012 PSA--%>
                </HeaderTemplate>
                <ContentTemplate>
                    <%--<art:Reporte_v2_Precio_SF_AAVV_CB ID="Reporte_v2_Precio_SF_AAVV_CB" runat="server" />--%>
                    <rsweb:ReportViewer ID="rpt_incidencia_nivelsf" runat="server" Font-Names="Verdana"
                        Font-Size="8pt" ProcessingMode="Remote" Style="width: auto" ShowParameterPrompts="False"
                        ToolTip="Comparativo" SizeToReportContent="True" ZoomMode="FullPage" Visible="False">
                    </rsweb:ReportViewer>
                </ContentTemplate>
            ...
            <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel11">
                ...
                <ContentTemplate>
                    <%--<art:Reporte_v2_Precio_SF_AAVV_CB ID="Reporte_v2_Precio_SF_AAVV_CB" runat="server" />--%>
                    <rsweb:ReportViewer ID="rpt_incidencia_tnivelsf" runat="server" Font-Names="Verdana"
                        Font-Size="8pt" ProcessingMode="Remote" Style="width: auto" ShowParameterPrompts="False"
                        ToolTip="Comparativo" SizeToReportContent="True" ZoomMode="FullPage" Visible="False">
                    </rsweb:ReportViewer>
                </ContentTemplate>
            ...
            <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel7">
                <HeaderTemplate>
                    Nivel(Prod/Serv)
                    <%--Incid. Nivel (Prod/Serv)--%>
                </HeaderTemplate>
                <ContentTemplate>
                    <%--<art:Reporte_v2_Precio_SF_AAVV_CB ID="Reporte_v2_Precio_SF_AAVV_CB" runat="server" />--%>
                    <rsweb:ReportViewer ID="rpt_incidencia_nivelps" runat="server" Font-Names="Verdana"
                        Font-Size="8pt" ProcessingMode="Remote" Style="width: auto" ShowParameterPrompts="False"
                        ToolTip="Comparativo" SizeToReportContent="True" ZoomMode="FullPage" Visible="False">
                    </rsweb:ReportViewer>
                </ContentTemplate>
            ...
            <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel6">
                ...
                <ContentTemplate>
                    <%--<art:Reporte_v2_Precio_SF_AAVV_CB ID="Reporte_v2_Precio_SF_AAVV_CB" runat="server" />--%>
                    <rsweb:ReportViewer ID="rpt_incidencia_nivel6" runat="server" Font-Names="Verdana"
                        Font-Size="8pt" ProcessingMode="Remote" Style="width: auto" ShowParameterPrompts="False"
                        ToolTip="Comparativo" SizeToReportContent="True" ZoomMode="FullPage" Visible="False">
                    </rsweb:ReportViewer>
                </ContentTemplate>
