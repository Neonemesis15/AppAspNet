<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Pages/Modulos/Cliente/Reportes/MasterPageV2/design/MasterPage.master"
    CodeBehind="Reporte_v2_PresenciaColgate_ES_IT.aspx.cs" Inherits="SIGE.Pages.Modulos.Cliente.Reportes.Reporte_v2_PresenciaColgate_ES_IT" %>
        ...
        <telerik:RadPane ID="RadPane_contenidoReportes" runat="server">
            <div>
                <asp:UpdatePanel ID="up_report" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <rsweb:ReportViewer ID="Report_ES_IT" runat="server" Font-Names="Verdana" Font-Size="8pt"
