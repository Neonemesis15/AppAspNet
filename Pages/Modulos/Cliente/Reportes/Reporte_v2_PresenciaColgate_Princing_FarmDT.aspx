<%@ Page Language="C#" MasterPageFile="~/Pages/Modulos/Cliente/Reportes/MasterPageV2/design/MasterPage.master"
    AutoEventWireup="true" CodeBehind="Reporte_v2_PresenciaColgate_Princing_FarmDT.aspx.cs"
    Inherits="SIGE.Pages.Modulos.Cliente.Reportes.Reporte_v2_PresenciaColgate_Princing_FarmDT" %>
...
<asp:Content ID="SheetContent" ContentPlaceHolderID="SheetContentPlaceHolder" runat="Server">
    <telerik:RadSplitter ID="RadSplinter_presencia" runat="server" Orientation="Vertical"
        ...
        <telerik:RadPane ID="RadPane_contenidoReportes" runat="server">
            <div>
                <rsweb:ReportViewer ID="ReportPricing" runat="server" Font-Names="Verdana" Font-Size="8pt"
