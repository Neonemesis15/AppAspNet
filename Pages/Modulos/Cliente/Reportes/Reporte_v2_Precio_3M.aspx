<%@ Page Language="C#"  MasterPageFile="~/Pages/Modulos/Cliente/Reportes/MasterPageV2/design/MasterPage.master" 
 AutoEventWireup="true" CodeBehind="Reporte_v2_Precio_3M.aspx.cs" Inherits="SIGE.Pages.Modulos.Cliente.Reportes.Reporte_v2_Precio_3M" %>
                    ...
                    <asp:TabPanel ID="TabFiltros" runat="server" HeaderText="TabPanel1">
                      ...
                      <telerik:RadComboBox ID="cmb_periodo" runat="server" Width="238px" Skin="Vista">
                       ...
                       <telerik:RadComboBox ID="cmb_categoria" runat="server" Width="238px" Skin="Vista">
                        ...
                        <td>
                       <telerik:RadComboBox ID="cmbDepartamento" runat="server" Width="238px" Skin="Vista">
                                            </telerik:RadComboBox>
                        </td>
                        <td>
                        Producto
...
<ContentTemplate>
                            <div>
                                <asp:UpdatePanel ID="upquiebre" runat="server"><ContentTemplate>
