<%@ Page Language="C#" MasterPageFile="~/Pages/Modulos/Cliente/Reportes/MasterPageV2/design/MasterPage.master"
    AutoEventWireup="true" CodeBehind="Reporte_v2_PresenciaColgate_Min.aspx.cs" Inherits="SIGE.Pages.Modulos.Cliente.Reportes.Reporte_v2_PresenciaColgate_Min"
...
<asp:Content ID="SheetContent" ContentPlaceHolderID="SheetContentPlaceHolder" runat="Server">
                            ...
                            <ContentTemplate>
                                <cc1:TabContainer ID="TabContainer_filtros" runat="server" ActiveTabIndex="1" CssClass="cyan">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <telerik:RadComboBox ID="cmb_oficina" runat="server" Width="238px" Skin="Vista" Visible="false"
                                                            OnSelectedIndexChanged="cmb_oficina_SelectedIndexChanged" AutoPostBack="true">
                                                        </telerik:RadComboBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <cc1:TabPanel ID="TabMisFavoritos" runat="server" HeaderText="TabPanel1">
                                        ...
                                        <ContentTemplate>
                                            <asp:UpdatePanel ID="up_MisFavoritos" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
    ...
    <%--  <asp:UpdatePanel ID="UpdatePanel_editor" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div>
                <asp:Button ID="disparar_Editor" runat="server" CssClass="alertas" Text="ocultar"
                    Width="95px" />
                <cc1:ModalPopupExtender ID="ModalPopupExtender_Editor" runat="server" TargetControlID="disparar_Editor"
                    PopupControlID="Panel_Editor">
                </cc1:ModalPopupExtender>
                <asp:Panel ID="Panel_Editor" runat="server">
                   <uc7:UC_Form_TextEditor ID="UC_Form_TextEditor1" runat="server" />
                </asp:Panel>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>--%>
