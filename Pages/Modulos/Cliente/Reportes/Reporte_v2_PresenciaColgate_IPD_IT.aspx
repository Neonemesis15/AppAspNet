<%@ Page Language="C#" MasterPageFile="~/Pages/Modulos/Cliente/Reportes/MasterPageV2/design/MasterPage.master"
    AutoEventWireup="true" CodeBehind="Reporte_v2_PresenciaColgate_IPD_IT.aspx.cs"
    Inherits="SIGE.Pages.Modulos.Cliente.Reportes.Reporte_v2_PresenciaColgate_IPD_IT" %>

<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"
    Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>
<%@ Register Src="Informes_validacion/UC_ValidarPeriodos.ascx" TagName="UC_ValidarPeriodos"
    TagPrefix="uc1" %>
                                        ...
                                        <ContentTemplate>
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <telerik:RadComboBox ID="cmb_ciudad" runat="server">
                                                        </telerik:RadComboBox>
                                                    </td>
                                                </tr>
                                            </table>
        ...
        <telerik:RadPane ID="RadPane_contenidoReportes" runat="server">
            <div>
                <asp:UpdatePanel ID="up_report" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <rsweb:ReportViewer ID="ReportIndexPriceDatail" runat="server" Font-Names="Verdana"
                            Font-Size="8pt" ProcessingMode="Remote" Height="540px" Width="100%" ShowParameterPrompts="False"
                            ToolTip="Wholesalers Reports" ZoomPerc  ent="100" DocumentMapWidth="100%" SizeToReportContent="false"
