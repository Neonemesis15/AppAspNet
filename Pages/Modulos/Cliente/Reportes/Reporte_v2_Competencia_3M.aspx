<%@ Page Language="C#"   MasterPageFile="~/Pages/Modulos/Cliente/Reportes/MasterPageV2/design/MasterPage.master" 
 AutoEventWireup="true" CodeBehind="Reporte_v2_Competencia_3M.aspx.cs" Inherits="SIGE.Pages.Modulos.Cliente.Reportes.Reporte_v2_Competencia_3M" %>
                ...
                <asp:TabContainer ID="TabContainer_filtros" runat="server" ActiveTabIndex="0" CssClass="cyan">
                    <asp:TabPanel ID="TabFiltros" runat="server" HeaderText="TabPanel1">
                        ...
                        Fecha:desde
                         ...
                         <td>
                        <telerik:RadDatePicker ID="dtpDesde" runat="server" Width="238px" 
                                 Culture="es-PE">
                        ...
                        Fecha:Hasta
                         ...
                         <td>
                        <telerik:RadDatePicker ID="dtpHasta" runat="server" Width="238px" 
                                 Culture="es-PE">
                                        <Calendar UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False" 
                                            ViewSelectorText="x">
                                        </Calendar>
                        ...
                        Cadena
                         ...
                         <td>
                             <telerik:RadComboBox ID="cmb_cadena" runat="server" Skin="Vista" Width="238px">
                             </telerik:RadComboBox>
                        </td>
                          <td>
                              Tienda
                         ...
                         <td>
                             <telerik:RadComboBox ID="cmbTienda" runat="server" Skin="Vista" Width="238px">
                             </telerik:RadComboBox>
                        </td>
                        </table>
                        </ContentTemplate>
                                ...
                                <asp:UpdatePanel ID="upquiebre" runat="server">
                                    <ContentTemplate>
                                        <rsweb:ReportViewer ID="ReporPrecio" runat="server" Font-Names="Verdana" Font-Size="8pt"
                                            ProcessingMode="Remote" Style="width: auto" ShowParameterPrompts="False" ToolTip="Reporte Precio"
