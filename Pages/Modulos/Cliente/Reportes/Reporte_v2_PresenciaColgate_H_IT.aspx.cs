...
{
    public partial class Reporte_v2_PresenciaColgate_H_IT : System.Web.UI.Page
    {
        ...
        private void cargarReportHistory()
        {
            RadComboBox cmb_periodo = RadPanelBar_menu.FindChildByValue<RadPanelItem>("filtro").FindControl("cmb_periodo") as RadComboBox;
            RadComboBox cmb_año = RadPanelBar_menu.FindChildByValue<RadPanelItem>("filtro").FindControl("cmb_año") as RadComboBox;
            RadComboBox cmb_mes = RadPanelBar_menu.FindChildByValue<RadPanelItem>("filtro").FindControl("cmb_mes") as RadComboBox;
            ...
            Report_H.Visible = true;

            Report_H.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            Report_H.ZoomMode = Microsoft.Reporting.WebForms.ZoomMode.Percent;
            Report_H.ServerReport.ReportPath = "/Reporte_Precios_V1/Reporte_PresenciaHistoricoITColgate";

            String strConnection = ConfigurationManager.AppSettings["SERVIDOR_REPORTING_SERVICES"];

            Report_H.ServerReport.ReportServerUrl = new Uri(strConnection);
            Report_H.ServerReport.ReportServerCredentials = new CFG.Tools.ReportServerNetCredentials();
            ...
            Report_H.ServerReport.SetParameters(parametros);
        }
