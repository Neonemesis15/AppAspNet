<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Pages/Modulos/Cliente/Reportes/MasterPageV2/design/MasterPage.master"
CodeBehind="Reporte_v2_Fotografico_SF_Tra.aspx.cs" Inherits="SIGE.Pages.Modulos.Cliente.Reportes.Galeria_fotografica.Reporte_v2_Fotografico_SF_Tra" %>
                            ...
                            <table style="width: auto; height: auto;" align="center" class="art-Block-body">
                                ...
                                <tr>
                                 ...
                                 <td align="right">
                                    ...
                                    <td>
                                    <telerik:RadComboBox ID="cmb_distribuidora" runat="server" Width="238px" 
                                            Skin="Vista">
                                        </telerik:RadComboBox>
                                    </td>
                                    <td align="right">
                                    ...
                                    <telerik:RadComboBox ID="cmb_distrito" runat="server" Width="238px"
                                            Skin="Vista">
                                        </telerik:RadComboBox>
                                        </td>
                                ...
                                <tr>
                                  <td align="right">
                                    Tipo de Punto_de_Venta
                                    </td>
                                    <td>
                                    <telerik:RadComboBox ID="cmb_tipoPuntoVenta" runat="server" Width="238px" 
                                            Skin="Vista" >
                                        </telerik:RadComboBox>
                                    </td>
                                <td align="right">
                                    ...
                                    <td><telerik:RadComboBox ID="cmb_puntoVenta" runat="server" Width="238px" 
                                            Skin="Vista" >
                                        </telerik:RadComboBox>
                                    </td>
                                    <td align="right">Generador</td>
                                    <td><telerik:RadComboBox ID="cmb_Generador" runat="server" Width="238px" 
                                            Skin="Vista" >
                                        </telerik:RadComboBox>
                                    </td>
                                   ...
                                   <td align="right">Supervisor</td>
                                    <td><telerik:RadComboBox ID="cmb_Supervisor" runat="server" Width="238px"
                                            Skin="Vista" >
