...
{
    public partial class Reporte_v2_Disponibilidad_3M : System.Web.UI.Page
    {
        ...
        private void ObtenerInformeSug_Producto()
        {
            ...
            try
            {
                ...
                ReporDisp.Visible = true;
                ReporDisp.ZoomMode = Microsoft.Reporting.WebForms.ZoomMode.FullPage;
                ReporDisp.ServerReport.ReportPath = "/Reporte_Precios_V1/Reporte_Disponibilidad_3M";


                String strConnection = ConfigurationManager.AppSettings["SERVIDOR_REPORTING_SERVICES"];

                ReporDisp.ServerReport.ReportServerUrl = new Uri(strConnection);
                ReporDisp.ServerReport.ReportServerCredentials = new CFG.Tools.ReportServerNetCredentials();
                ...
                parametros.Add(new Microsoft.Reporting.WebForms.ReportParameter("Familias", cmb_categoria.SelectedValue));
                parametros.Add(new Microsoft.Reporting.WebForms.ReportParameter("Tienda", cmb_categoria.SelectedValue));
                ...
                ReporDisp.ServerReport.SetParameters(parametros);
            }
            catch (Exception ex)
            {
