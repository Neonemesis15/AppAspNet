<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Modulos/Cliente/Reportes/MasterPageV2/design/MasterPage.master" AutoEventWireup="true" CodeBehind="Reporte_v2_Disponibilidad_3M.aspx.cs" Inherits="SIGE.Pages.Modulos.Cliente.Reportes.Reporte_v2_Disponibilidad_3M" %>
            ...
            <div id="Div_filtros" runat="server" align="center" style="width: auto;" visible="false">
                <asp:TabContainer ID="TabContainer_filtros" runat="server" ActiveTabIndex="0" CssClass="cyan">
                    <asp:TabPanel ID="TabFiltros" runat="server" HeaderText="TabPanel1">
                        ...
                        <td>
                        <telerik:RadComboBox ID="cmb_tienda" runat="server" Skin="Vista" Width="238px">
                                            </telerik:RadComboBox>
                        </td>
                           <td>
                        Categoria
                        ...
                        Material POP
                          ...
                          <td>
                        <telerik:RadComboBox ID="cmbMPOP" runat="server" Width="238px" Skin="Vista">
                                            </telerik:RadComboBox>
                        </td>
                          <td>
                        Familia
                          ...
                          <td>
                        <telerik:RadComboBox ID="cmbFamilia" runat="server" Skin="Vista" Width="238px">
                                            </telerik:RadComboBox>
                        </td>
                        </tr>
                        </table>
                        ...
                        <ContentTemplate>
                            <div>
                                <asp:UpdatePanel ID="upquiebre" runat="server">
                                    <ContentTemplate>
                                        <rsweb:ReportViewer ID="ReporDisp" runat="server" Font-Names="Verdana" Font-Size="8pt"
                                            ProcessingMode="Remote" Style="width: auto" ShowParameterPrompts="False" ToolTip="Reporte De Exhibiciones Adicionales"
