<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Modulos/Cliente/Reportes/MasterPageV2/design/MasterPage.master" AutoEventWireup="true" CodeBehind="Reporte_v2_PresenciaColgate_Bodegas.aspx.cs" Inherits="SIGE.Pages.Modulos.Cliente.Reportes.Reporte_v2_PresenciaColgate_Bodegas" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
    <telerik:RadSplitter ID="RadSplinter_presencia" runat="server" Orientation="Vertical"
                                        ...
                                        <ContentTemplate>
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <telerik:RadComboBox ID="cmb_cobertura" runat="server">
                                                        </telerik:RadComboBox>
                                                    </td>
                                                </tr>
                                            </table>
                            ...
                            <telerik:RadPanelItem runat="server" Value="menu" Height="500px">
                                <ItemTemplate>
                                    <telerik:RadMenu ID="rad_menu" runat="server" Flow="Vertical" EnableRoundedCorners="true"
                                        ...
                                        Skin="Outlook" OnItemClick="RadMenu_ItemClick">
                                    </telerik:RadMenu>
                                </ItemTemplate>
                            </telerik:RadPanelItem>
                        </Items>
        ...
        <telerik:RadPane ID="RadPane_contenidoReportes" runat="server" Scrolling="Both">
            <div>
                <rsweb:ReportViewer ID="ReportProductos" runat="server" Font-Names="Verdana" Font-Size="8pt"
