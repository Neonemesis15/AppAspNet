...
{
    public partial class Mod_Cliente_Biblioteca_Tipo : System.Web.UI.Page
    {
        int Table = 0;
        ...
        private void Obtener_Categorias()
        {
            try
            {
                ...
                DataSet dsMateriales = oCoon.ejecutarDataSet("UP_WEBXPLORA_CLIE_OBTENERTIPOMATERIAL"); 
                    
                    //Get_DataClientes.Get_ObtenerCategoriasPOP(Convert.ToInt32(this.Session["companyid"]), this.Session["Canal"].ToString().Trim());
                ListViewMateriales.DataSource = dsMateriales.Tables[0];
                ListViewMateriales.DataBind();
        ...
        //        DataSet dsmarca = oCoon.ejecutarDataSet("UP_WEBXPLORA_BPOP_OBTENERMARCASXTIPOMATERIAL", Convert.ToInt32(this.Session["tipomaterial"]), Convert.ToInt32(this.Session["companyid"]), this.Session["Canal"].ToString().Trim());
        //            //Get_DataClientes.Get_ObtenerMarcasPOP(this.Session["categoria"].ToString().Trim(), Convert.ToInt32(this.Session["companyid"]), this.Session["Canal"].ToString().Trim());
        ...
        private void Obtener_MenusMaterial()
        {
            try
            {
                ...
                int tipomate;
                tipomate= Convert.ToInt32(this.Session["tipomaterial"]);
                DataSet dsMaterial = oCoon.ejecutarDataSet("UP_WEBXPLORA_BMA_OBTENERMATERIATIPOMATERIAL", tipomate, Convert.ToInt32(this.Session["companyid"]));
                    //Get_DataClientes.Get_ObtenerPOPxMarca(this.Session["categoria"].ToString(), Convert.ToInt32(this.Session["companyid"]), Convert.ToInt32(MenuMarcas.SelectedValue), this.Session["Canal"].ToString().Trim());
                //if (this.Session["Canal"].ToString().Trim() == "0")
                //{
                //    Table = 0;
                //}
        ...
        //private void BibliotecaXMateriales()
        //{
        //    try
        //    {
        //        int tipomate;
        //        tipomate = Convert.ToInt32(this.Session["tipomaterial"]);
        //        DataSet dsBiblioteca = oCoon.ejecutarDataSet("UP_WEBSIGE_CLIENTE_OBTENERFOTOSBIBLIOMATERIAL", Convert.ToInt32(this.Session["companyid"]), tipomate, Convert.ToInt32(this.Session["id_Brand"]), Convert.ToInt32(this.Session["id_material"]), this.Session["Canal"].ToString().Trim());
        //        if (this.Session["Canal"].ToString().Trim() == "0")
        //        {
        //            Table = 2;
        //        }
        ...
        private void BibliotecaXMarca()
        {
            try
            {
                int tipomate;
                tipomate= Convert.ToInt32(this.Session["tipomaterial"]);
                DataSet dsBiblioteca = oCoon.ejecutarDataSet("UP_WEBSIGE_CLIENTE_OBTENERFOTOSBIBLIOTECAMATERIAL", Convert.ToInt32(this.Session["companyid"]), tipomate, Convert.ToInt32(this.Session["id_material"]));
                //if (this.Session["Canal"].ToString().Trim() == "0")
                //{
        ...
        private void BibliotecaDetalle()
        {
            try
            {
                ...
                DataSet dsBibliotecaDetalle = oCoon.ejecutarDataSet("UP_WEBSIGE_CLIENTE_OBTENERFOTOSBIBLIOTECAMATDETALLE",Convert.ToInt32(this.Session["Biblioteca"]));
                    //Get_DataClientes.Get_ObtenerPOPDetallado(Convert.ToInt32(this.Session["Biblioteca"]));
        ...
        protected void ListViewMateriales_SelectedIndexChanging(object sender, ListViewSelectEventArgs e)
        {
            ListViewItem item = (ListViewItem)ListViewMateriales.Items[e.NewSelectedIndex];
            this.Session["MaterialSeleccionado"] = e.NewSelectedIndex;
        }
        protected void ListViewMateriales_PagePropertiesChanging(object sender, PagePropertiesChangingEventArgs e)
        {
            // Clear selection. 
            ListViewMateriales.SelectedIndex = -1;
        }
