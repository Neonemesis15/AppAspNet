...
{
    public partial class Report_Competencia_Cementos : System.Web.UI.Page
    {
        ...
        protected void cmbplanning_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cmbplanning.SelectedIndex != 0)
            {
                ...
                cargarCombo_Categoria(sidplanning);
        ...
        protected void cargarGrilla_ReporteFotografico()
        {
            try
            {
                ...
                else
                {
                    ...
                    dt_Foto = oCoon.ejecutarDataTable("WEB_XPLORA_DATAMERCADERISTA_COMPETENCIA_CEMENTOSLIMA", compañia, sidplanning, sidchannel, iidNodeComercial, sidPDV, iidperson, cmbEmpresa.SelectedValue, cmbCategoria.SelectedValue, idMarca, cmbTipoCompetencia.SelectedValue, cmdTipoActividad.SelectedValue, cmbciudad.SelectedValue, scodDistrito, dfecha_inicio, dfecha_fin);
        ...
        protected void btn_validar_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < gv_Foto.Items.Count; i++)
            {
                ...
                Label lbl_Regdetalle = (Label)item.FindControl("lbl_Regdetalle");


                int id = Convert.ToInt32(lbl_Regdetalle.Text.Trim());
        ...
        protected void update_fotografico_detalle_validado(int id, bool validar)
        {
            ...
            {
                Conexion Ocoon = new Conexion();
                Ocoon.ejecutarDataReader("UP_WEBXPLORA_OPE_ACTUALIZAR_REPORTE_COMPETENCIA_VALIDADO", id, validar);
            }
            catch (Exception ex)
            {
                ex.Message.ToString();
        ...
        protected void gv_Foto_UpdateCommand(object source, GridCommandEventArgs e)
        {
            try
            {
                ...
                int iid_ReportCompetencia = Convert.ToInt32(lbl_Id_Reg_Competencia.Text.Trim());


                Label lbl_Id_Reg_Foto = (Label)item.FindControl("lbl_Reg_Foto");
                int iid_Reg_foto = Convert.ToInt32(lbl_Id_Reg_Foto.Text.Trim());
                ...
                string mecanica = ArrayEditorValue[0].ToString();

                string MateApoyo = ArrayEditorValue[1].ToString();
                string fechaini = ArrayEditorValue[2].ToString();
                string fechafin = ArrayEditorValue[4].ToString();
                string precio = ArrayEditorValue[6].ToString();
                string observacion = ArrayEditorValue[7].ToString();


                Ocoon.ejecutarDataReader("UP_WEBXPLORA_OPE_ACTUALIZAR_REPORTE_COMPETENCIA_CEMENTOSLIMA", iid_ReportCompetencia, iid_Reg_foto, mecanica, MateApoyo, fechaini, fechafin
                , precio, observacion, Session["sUser"].ToString(), DateTime.Now);
        ...
        protected void gv_Foto_ItemCommand(object source, GridCommandEventArgs e)
        {
            try
            {
                ...
                Label lbl_Id_Reg_Fotogr = (Label)item.FindControl("lbl_Id_Reg_Competencia");
        ...
        protected void gv_Foto_ItemDataBound(object sender, GridItemEventArgs e)
        {
            ...
            if (e.Item is GridEditableItem && (e.Item as GridEditableItem).IsInEditMode)
            {
                ...
                dt = Ocoon.ejecutarDataTable("MaterialPOPXPlanning", cmbplanning.SelectedValue );

                //
                GridDropDownListColumnEditor ddlPOP = editMan.GetColumnEditor("ddlPOP") as GridDropDownListColumnEditor;
                ...
                ddlPOP.DataSource = dt;
                ddlPOP.DataValueField = "id_MPointOfPurchase";
                ddlPOP.DataTextField = "POP_name";
                ddlPOP.DataBind();
        ...
        protected void cargarCombo_Categoria(string sidplanning)
        {
            DataTable dt = null;
            Conexion Ocoon = new Conexion();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                cmbCategoria.Items.Insert(0, new ListItem("---Todas---", "0"));
        ...
        protected void cmbCategoria_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string sidcategoriaproducto = cmbCategoria.SelectedValue;
            dt = Ocoon.ejecutarDataTable("UP_WEBXPLORA_OPE_COMBO_MARCA_REPORT_PRECIO", sidcategoriaproducto);
        ...
        protected void llenaEmpresa()
        {
            ...
            dt = Ocoon.ejecutarDataTable("EmpresaCompetidoraXCompany", Convert.ToInt32(this.Session["companyid"]));
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                cmbEmpresa.DataValueField = "Company_id";
                cmbEmpresa.DataTextField = "Empresa";
                cmbEmpresa.DataBind();
                cmbEmpresa.Items.Insert(0, new ListItem("---Todas---", "0"));
        ...
        protected void llenaTipoCompetencia()
        {
            DataTable dt = null;
            Conexion Ocoon = new Conexion();


            dt = Ocoon.ejecutarDataTable("ConsultaOPE_TIPO_REPORTE", Convert.ToInt32(this.Session["companyid"]), "Tipo_Comp");

            cmbTipoCompetencia.Items.Clear();
            cmbTipoCompetencia.Enabled = false;

            if (dt.Rows.Count > 0)
            {
                cmbTipoCompetencia.DataSource = dt;
                cmbTipoCompetencia.DataValueField = "id_Tipo_Reporte";
                cmbTipoCompetencia.DataTextField = "TipoReporte_Descripcion";
                cmbTipoCompetencia.DataBind();
                cmbTipoCompetencia.Items.Insert(0, new ListItem("---Todas---", "0"));
                cmbTipoCompetencia.Enabled = true;
            }
        ...
        protected void llenaTipoActividad()
        {
            ...
            dt = Ocoon.ejecutarDataTable("ConsultaOPE_TIPO_REPORTE", Convert.ToInt32(this.Session["companyid"]), "Tipo_Act");

            cmdTipoActividad.Items.Clear();
            cmdTipoActividad.Enabled = false;

            if (dt.Rows.Count > 0)
            {
                cmdTipoActividad.DataSource = dt;
                cmdTipoActividad.DataValueField = "id_Tipo_Reporte";
                cmdTipoActividad.DataTextField = "TipoReporte_Descripcion";
                cmdTipoActividad.DataBind();
                cmdTipoActividad.Items.Insert(0, new ListItem("---Todas---", "0"));
                cmdTipoActividad.Enabled = true;
            }
