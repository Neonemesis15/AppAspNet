<%@ Page Language="C#" MasterPageFile="~/Pages/Modulos/Operativo/Reports/MasterPage/design/MasterPage2.master"
    AutoEventWireup="true" CodeBehind="Report_SF_Tra_ExaTda.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.Report_SF_Tra_ExaTda" %>
...
<asp:Content ID="SheetContent" ContentPlaceHolderID="SheetContentPlaceHolder" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel_contenido" runat="server">
        <ContentTemplate>
            ...
            <div id="div_ExamenTda" runat="server" class="class_div" style="width: auto; height: auto;">
                <div align="right">
                    <asp:Label ID="lbl_cb_all" runat="server" Text="Seleccionar todos" Font-Size="Small"></asp:Label>
                    <asp:CheckBox ID="cb_all" runat="server" Font-Size="Small" OnCheckedChanged="cb_all_CheckedChanged"
                        AutoPostBack="True" />
                </div>
               <div>
                            <telerik:RadGrid ID="gv_ExamenTienda" runat="server" AutoGenerateColumns="False"
                                PageSize="15" Skin="Vista" Font-Size="Small" AllowPaging="True" GridLines="None"
                                ShowFooter="True" OnCancelCommand="gv_precios_CancelCommand" OnEditCommand="gv_precios_EditCommand"
                                OnPageIndexChanged="gv_precios_PageIndexChanged" OnPageSizeChanged="gv_precios_PageSizeChanged"
                                OnUpdateCommand="gv_precios_UpdateCommand" OnItemDataBound="OnItemDataBoundHandler" Height="620px">
                                <MasterTableView NoMasterRecordsText="Sin Datos para mostrar." ForeColor="#00579E"
                                    ...
                                    <Columns>
                                        <telerik:GridBoundColumn DataField="Distribuidor" HeaderText="Distribuidor" UniqueName="Distribuidor"
                                            ReadOnly="true">
                                        ...
                                        <telerik:GridBoundColumn DataField="Dirección" HeaderText="Dirección" UniqueName="Dirección"
                                            ReadOnly="true">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="Distrito" HeaderText="Distrito" UniqueName="Distrito"
                                            ReadOnly="true">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="Provincia" HeaderText="Provincia" UniqueName="Provincia"
                                            ReadOnly="true">
                                        </telerik:GridBoundColumn>
                                        ...
                                        <telerik:GridBoundColumn DataField="HorarioAtencion1" HeaderText="Horario_de_Atencion_01"
                                            UniqueName="HorarioAtencion1">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="HorarioAtencion2" HeaderText="Horario_de_Atencion_02"
                                            UniqueName="HorarioAtencion2">
                                        </telerik:GridBoundColumn>
                                        
                                        <telerik:GridBoundColumn DataField="DiaDescanso" HeaderText="Día_de_Descanso" UniqueName="DiaDescanso"
                                            ReadOnly="True">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridDropDownColumn  Visible="false"  HeaderText="Día_de_Descanso" UniqueName="ddlDiaDescanso" ReadOnly="false">
                                        </telerik:GridDropDownColumn>
                                        
                                        <telerik:GridBoundColumn DataField="descripcion_Giro" HeaderText="Giro_del_PDV" UniqueName="ddlGiroPDV"
                                            ReadOnly="True">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridDropDownColumn  Visible="false"  HeaderText="Giro_del_PDV" UniqueName="ddldescripcion_Giro" ReadOnly="false">
                                        </telerik:GridDropDownColumn>
                                        
                                        <telerik:GridBoundColumn DataField="descripcion_Location" HeaderText="Ubicación"
                                            UniqueName="descripcionLocation" ReadOnly="True">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridDropDownColumn  Visible="false"  HeaderText="Ubicación" UniqueName="ddlUbicacion" ReadOnly="false">
                                        </telerik:GridDropDownColumn>
                                        
                                        <telerik:GridBoundColumn DataField="ptoConsumo" HeaderText="¿Es_Punto_de_Consumo?"
                                            UniqueName="ptoConsumo" ReadOnly="True">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridDropDownColumn  Visible="false"  HeaderText="¿Es_Punto_de_Consumo?" UniqueName="ddlPtoConsumo" ReadOnly="false">
                                        </telerik:GridDropDownColumn>

                                        <telerik:GridBoundColumn DataField="descripcion_Size" HeaderText="Tamaño_del_Pto_de_Venta"
                                            UniqueName="descripcionSize" ReadOnly="True">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridDropDownColumn  Visible="false"  HeaderText="Tamaño_del_Pto_de_Venta" UniqueName="ddlSizePtoConsumo" ReadOnly="false">
                                        </telerik:GridDropDownColumn>
                                        
                                        <telerik:GridBoundColumn DataField="HorneaPavo" HeaderText="¿Hornea_Pavo?" UniqueName="HorneaPavo"
                                            ReadOnly="True">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridDropDownColumn  Visible="false"  HeaderText="¿Hornea_Pavo?" UniqueName="ddlHorneaPavo" ReadOnly="false">
                                        </telerik:GridDropDownColumn>

                                        <telerik:GridBoundColumn DataField="descripcion_Equipment" HeaderText="Equipo_de_Frio"
                                            UniqueName="descripcion_Equipment" ReadOnly="True">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="mercaderista" HeaderText="Mercaderista:" UniqueName="mercaderista"
                                            ReadOnly="true">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="Fec_Reg_Bd" HeaderText="Fecha_de_Registro" UniqueName="Fec_Reg_Bd"
                                            ReadOnly="true">
                                        </telerik:GridBoundColumn>
                                        ...
                                        <telerik:GridTemplateColumn UniqueName="TemplateColumn">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblregActDatosDetalle" Text='<%#Eval("id_reg_DetActDatos") %>' runat="server" Visible="false"></asp:Label>
                                                <asp:Label ID="lblregActDatos" Text='<%#Eval("Id_rpactdatospdv") %>' runat="server" Visible="false"></asp:Label>
                                            </ItemTemplate>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td colspan="3">
                <asp:GridView ID="gv_ExamenTiendaToExcel" runat="server" BackColor="White" BorderColor="#CCCCCC"
