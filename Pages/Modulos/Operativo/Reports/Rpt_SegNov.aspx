<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Modulos/Operativo/Reports/MasterPage/design/MasterPage2.master"
    AutoEventWireup="true" CodeBehind="Rpt_SegNov.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.Rpt_SegNov" %>
        ...
        <ContentTemplate>
            <table style="width: 1111px; height: auto;" class="style1">
                <tr>
                    <td class="style11" colspan="2">
                        &nbsp; SEGUIMIENTO DE VISITAS NO EFECTIVAS
                    </td>
                </tr>
                <tr>
                    <td class="style8">
                ...
                <tr>
                    ...
                    <td class="style5">
                        <asp:DropDownList ID="cmbmotivos" runat="server" Height="25px" Width="275px" Enabled="False">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
            ...
            <div id="dvrnv" runat="server" class="class_div" style="width: auto; height: auto;">
                <rsweb:ReportViewer ID="Rptsegnv" runat="server" Font-Names="Verdana" Font-Size="8pt"
                    ProcessingMode="Remote" Style="width: auto" ShowParameterPrompts="False" ToolTip="Seguimiento No visitas"
