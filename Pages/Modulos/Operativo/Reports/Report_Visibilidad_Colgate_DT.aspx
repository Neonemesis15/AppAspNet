<%@ Page Language="C#" MasterPageFile="~/Pages/Modulos/Operativo/Reports/MasterPage/design/MasterPage2.master" AutoEventWireup="true" CodeBehind="Report_Visibilidad_Colgate_DT.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.Report_Visibilidad_Colgate_DT" %>
    ...
    <asp:UpdatePanel ID="UpReportFotografico" runat="server">
        <ContentTemplate>
         <div align="center">
           ...
           <td><asp:DropDownList ID="cmbtiporeporte" runat="server" Height="25px" Width="275px"
                            Style="text-align: left" CausesValidation="True" OnSelectedIndexChanged="cmbtiporeporte_SelectedIndexChanged"
                            AutoPostBack="True">
                        </asp:DropDownList></td>
           <td  align="right"><asp:Label Visible="false" runat="server" ID="lblComentario" >Comentario :</asp:Label></td>
           <td>
               <asp:DropDownList ID="cmbComentario" runat="server" Visible="false"
                    Height="25px" 
                  Width="275px">
           ...
           <td  align="right"><asp:Label ID="lbl_marca" runat="server" Text="Marca : " Visible="False"></asp:Label></td>
           ...
           <asp:Label ID="lbl_supervisor" runat="server" Text="Supervisor : " Visible="False"></asp:Label>
                 ...
                 <td>
                                  <asp:DropDownList ID="cmbDistribuidor" runat="server" Height="25px" Width="275px" Enabled="False"
                            Visible="false">
                        </asp:DropDownList>
                 </td>
                 </tr>
                ...
                <telerik:RadGrid ID="gv_Foto" runat="server" AutoGenerateColumns="False" PageSize="2000"
                    ...
                    <MasterTableView NoMasterRecordsText="Sin Datos para mostrar." ForeColor="#00579E"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="Distribuidora" HeaderText="Distribuidora" UniqueName="Distribuidora" ReadOnly="true">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="Direccion" HeaderText="Direccion" UniqueName="Direccion" ReadOnly="true">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="Supervisor" HeaderText="Supervisor" UniqueName="Supervisor" ReadOnly="true">
                            </telerik:GridBoundColumn>
