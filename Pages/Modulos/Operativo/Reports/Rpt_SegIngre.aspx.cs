...
{
    public partial class Rpt_SegIngre : System.Web.UI.Page
    {
        ...
        protected void cmbcanal_SelectedIndexChanged(object sender, EventArgs e)
        {
           ...
           private void  LlenarPerson() {

            compañia = Convert.ToInt32(this.Session["companyid"]);
                  Conexion Ocoon = new Conexion();
            DataTable dt = null;

            dt = Ocoon.ejecutarDataTable("UP_GN_WEBXPLORA_OBTENERINGREDM", compañia);
            ...
            if (dt.Rows.Count > 0) {
                ...
                cmbperson.DataTextField = "Nombres";
                cmbperson.DataBind();
            ...
            try
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        Rptsegnv.ServerReport.ReportPath = "/Reporte_Precios_V1/Ingreso Supervisores Xplora";
