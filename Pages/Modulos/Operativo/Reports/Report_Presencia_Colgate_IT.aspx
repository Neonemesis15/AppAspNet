<%@ Page Language="C#" MasterPageFile="~/Pages/Modulos/Operativo/Reports/MasterPage/design/MasterPage2.master" AutoEventWireup="true" CodeBehind="Report_Presencia_Colgate_IT.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.Report_Presencia_Colgate_IT" %>
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <%
                                ...
                                for (int i = 0; i < dsElemento.Tables[2].Columns.Count; i++)
                                {
                            ...
                            <% 
                                    Response.Write("xD");
                                    Response.Write(dsElemento.Tables[2].Rows[0][i].ToString());
                                %>
                            </td>
                            <% } 
                                    ...
                                    <Columns>
                                        <telerik:GridTemplateColumn Visible="false" UniqueName="TemplateColumn" ReadOnly="true" ItemStyle-Width="100" >
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lbl_id_cliente" runat="server"
                                                    Visible="false"></asp:Label>
                                                <asp:Label ID="lbl_id_node"  runat="server"
                                                    Visible="false"></asp:Label>
                                                    <asp:Label ID="lbl_fecha"  runat="server"
                                                    Visible="false"></asp:Label>
                                                    <asp:Label ID="lbl_id_mercaderista"  runat="server"
                                                    Visible="false"></asp:Label>
                                            </ItemTemplate>
