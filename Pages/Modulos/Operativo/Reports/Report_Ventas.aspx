<%@ Page Language="C#" MasterPageFile="~/Pages/Modulos/Operativo/Reports/MasterPage/design/MasterPage2.master"
    AutoEventWireup="true" CodeBehind="Report_Ventas.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.Report_Ventas" %>
                ...
                <telerik:RadGrid ID="gv_ventas" runat="server" AutoGenerateColumns="False" PageSize="100"
                    ...
                    <MasterTableView NoMasterRecordsText="Sin Datos para mostrar." ForeColor="#00579E"
                        ...
                        <Columns>
                            ...
                            <telerik:GridNumericColumn DataField="PEDIDO" DataType="System.Double" EmptyDataText="0"
                                HeaderText="Pedido" UniqueName="PEDIDO">
                            </telerik:GridNumericColumn>
                            <telerik:GridNumericColumn DataField="INGRESO" DataType="System.Double" EmptyDataText="0"
                                HeaderText="Ingreso" UniqueName="INGRESO">
                            </telerik:GridNumericColumn>
                            <telerik:GridNumericColumn DataField="VENTA" DataType="System.Double" EmptyDataText="0"
                                HeaderText="Venta" UniqueName="VENTA">
                            </telerik:GridNumericColumn>
