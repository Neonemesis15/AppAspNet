<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Pages/Modulos/Operativo/Reports/MasterPage/design/MasterPage2.master" CodeBehind="Report_Fachada_Cementos.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.Report_Fachada_Cementos" %>
    ...
    <asp:UpdatePanel ID="UpReportFotografico" runat="server">
        <ContentTemplate>
         <div align="center">
            ...
            <legend  > Consultar Reporte Fachada</legend>
           ...
           <td  align="right">Tipo de Fachada:</td>
           <td><asp:DropDownList ID="cmbTipoFachada" runat="server"  Height="25px"
                           Width="275px"
                             Enabled="False">
                        </asp:DropDownList></td>
            </tr>
           ...
           <td  align="right"><asp:Label ID="lbl_marca" runat="server" Text="Status : " ></asp:Label></td>
           <td><asp:DropDownList ID="cmbstatus" runat="server" Height="25px" Width="275px" 
                   Enabled="False"
                   >
                        </asp:DropDownList></td>
            </tr>
           ...
           <td><asp:DropDownList ID="cmbciudad" runat="server"  Height="25px" Width="275px" 
                   AutoPostBack="True" onselectedindexchanged="cmbciudad_SelectedIndexChanged"
                            >
                        </asp:DropDownList></td>
           ...
           <td>&nbsp;</td>
            ...
            <div id="div_gvFoto" runat="server" aling="center" style="width: 100%; height: auto;">
                ...
                <telerik:RadGrid ID="gv_Foto" runat="server" AutoGenerateColumns="False" PageSize="2000"
                    ...
                    OnDataBound="gv_Foto_DataBound" OnItemCommand="gv_Foto_EditCommand" 
                    ...
                    <MasterTableView NoMasterRecordsText="Sin Datos para mostrar." ForeColor="#00579E"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="Tipo_Fachada" HeaderText="Tipo de Fachada" UniqueName="Tipo_Fachada"
                                ReadOnly="true">
                            </telerik:GridBoundColumn>
                            <telerik:GridDropDownColumn Visible="false"  HeaderText="Tipo de Fachada" UniqueName="ddlTipo_Fachada">
                            ...
                            <telerik:GridBoundColumn DataField="Fecha_Vencimiento" HeaderText="Fecha Vencimiento" UniqueName="Fecha_Vencimiento"
                                ReadOnly="true">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="Gestor" HeaderText="Registrado por" UniqueName="Gestor"
                                ReadOnly="true">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Validado" UniqueName="TemplateColumn" ReadOnly="true">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lbl_regFoto" runat="server" Text='<%# Bind("Id_regft") %>' Visible="false"></asp:Label>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
