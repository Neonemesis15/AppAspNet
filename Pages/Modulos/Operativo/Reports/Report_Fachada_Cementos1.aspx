<%@ Page Language="C#" MasterPageFile="~/Pages/Modulos/Operativo/Reports/MasterPage/design/MasterPage2.master" AutoEventWireup="true" CodeBehind="Report_Fachada_Cementos1.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.Report_Fachada_Cementos1" %>
                ...
                <telerik:RadGrid ID="gv_Foto" runat="server" AutoGenerateColumns="False" PageSize="2000"
                    ...
                    <MasterTableView NoMasterRecordsText="Sin Datos para mostrar." ForeColor="#00579E"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="Fecha_Vencimiento" HeaderText="Fecha de vencimiento (Permiso publicitario)" UniqueName="Fecha_Vencimiento"
                                ReadOnly="true">
                            </telerik:GridBoundColumn>
