...
{
    public partial class LevantamientoExhImpuls : System.Web.UI.Page
    {
        ...
        private OPE_REPORTE_EXHB_IMPULSO oreporPublicacion = new OPE_REPORTE_EXHB_IMPULSO();
       ...
       private void llenarpdvgrilla()
        {
            ...
            for (int i = 0; i <= GvLPublicaciones.Rows.Count - 1; i++)
            {
                    ...
                    ((DropDownList)GvLPublicaciones.Rows[i].Cells[5].FindControl("cmbCadena")).DataSource = ds.Tables[0];
                    ((DropDownList)GvLPublicaciones.Rows[i].Cells[5].FindControl("cmbCadena")).DataTextField = "pdv_Name";
                    ((DropDownList)GvLPublicaciones.Rows[i].Cells[5].FindControl("cmbCadena")).DataValueField = "id_ClientPDV";
                    ((DropDownList)GvLPublicaciones.Rows[i].Cells[5].FindControl("cmbCadena")).DataBind();
                    ((DropDownList)GvLPublicaciones.Rows[i].Cells[5].FindControl("cmbCadena")).Items.Insert(0, new ListItem("<Seleccione..>", "0"));
                
            }
        }
       private void llenarTipoactivdadgrilla()
       {
           DataSet ds = null;
           Conexion Ocoon = new Conexion();
           ...
           for (int i = 0; i <= GvLPublicaciones.Rows.Count - 1; i++)
           {
                   ...
                   ((DropDownList)GvLPublicaciones.Rows[i].Cells[6].FindControl("cmbTipo")).DataSource = ds.Tables[1];
                   ((DropDownList)GvLPublicaciones.Rows[i].Cells[6].FindControl("cmbTipo")).DataTextField = "descripcion";
                   ((DropDownList)GvLPublicaciones.Rows[i].Cells[6].FindControl("cmbTipo")).DataValueField = "id_Tipo_Act";
                   ((DropDownList)GvLPublicaciones.Rows[i].Cells[6].FindControl("cmbTipo")).DataBind();
       ...
       private void ConsultaGrillaSKU()
       {
           try
           {
               ...
               DataSet ds = oreporPublicacion.ConsultarGrillaLevaExhiImpulsoSKU(cmbBCampaña.SelectedValue, Convert.ToDateTime(TexBFecha.Text));
               ...
               for (int i = 0; i <= GvLPublicaciones.Rows.Count - 1; i++)
               {
                   ((Label)GvLPublicaciones.Rows[i].Cells[0].FindControl("lblcodregistro")).Text = ds.Tables[0].Rows[i]["id_exhbiImpl"].ToString().Trim();
                   ...
                   ((DropDownList)GvLPublicaciones.Rows[i].Cells[5].FindControl("cmbCadena")).Text = ds.Tables[0].Rows[i]["ClientPDV_code"].ToString().Trim();
                   ((DropDownList)GvLPublicaciones.Rows[i].Cells[6].FindControl("cmbTipo")).Text = ds.Tables[0].Rows[i]["id_Tipo_Act"].ToString().Trim();
                   ((TextBox)GvLPublicaciones.Rows[i].Cells[3].FindControl("txt_Inicio_Actividad")).Text = ds.Tables[0].Rows[i]["fec_ini_act"].ToString().Trim();
                   ((TextBox)GvLPublicaciones.Rows[i].Cells[4].FindControl("txt_Fin_Actividad")).Text = ds.Tables[0].Rows[i]["fec_fin_act"].ToString().Trim();
               }
       ...
       private void ConsultaGrillaFamilia()
       {
           try
           {
               ...
               DataSet ds = oreporPublicacion.ConsultarGrillaLevaExhiImpulso(cmbBCampaña.SelectedValue, Convert.ToDateTime(TexBFecha.Text));
               if (ds.Tables[0].Rows.Count > 0)
               {
       ...
       private void llenarGrillaConsulta()
       {
        ...
        protected void BtnCrearUsuInfo_Click(object sender, EventArgs e)
        {
            ...
            llenaplanningAASS();
            GvLPublicaciones.Visible = true;
            GvLPublicaciones.Columns[7].Visible = false;
        ...
        protected void BtnBuscarLevaP_Click(object sender, EventArgs e) 
        {
               ...
               
            {
                ...
                Alertas.CssClass = "MensajesError";
                LblFaltantes.Text = "Porfavor seleccione Planning y Recoger Por ";
                MensajeAlerta();
                ModalPopupLevantaPublicacion.Show();
                return;
            }
        ...
        protected void BtnSiConfirmaProd_Click(object sender, EventArgs e)
        {
            ...
            ds = Ocoon.ejecutarDataSet("UP_WEBXPLORA_OPE_ELIMINARLEVAEXHIBIMPULSO", Convert.ToInt32(((Label)GvLPublicaciones.Rows[row.RowIndex].Cells[0].FindControl("lblcodregistro")).Text));
            string variable="";
        ...
        protected void BtnCargaMasivaLP_Click(object sender, EventArgs e)
        {
            ...
            this.Session["TipoCarga"] = "Carga Levantamiento ExhibicImpulso";
            //this.Session["Fecha"]=txt_fechaActual.Text;
            //this.Session["Planning"]=cmbplanning.Text;
            //this.Session["RecogerPor"] = cmbRecoger.Text;
            //ModalCMasiva.Show();
