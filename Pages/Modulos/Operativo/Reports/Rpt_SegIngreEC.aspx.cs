...
{
    public partial class Rpt_SegIngreEC : System.Web.UI.Page
    {
        ...
        protected void cmbcanal_SelectedIndexChanged(object sender, EventArgs e)
        {
           ...
           private void  LlenarPerson() {
            ...
            dt = Ocoon.ejecutarDataTable("UP_GN_WEBXPLORA_OBTENERINGEC", compañia);
            ...
            try
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        Rptsegnv.ServerReport.ReportPath = "/Reporte_Precios_V1/Ingreso Ejecutivos  Xplora";
