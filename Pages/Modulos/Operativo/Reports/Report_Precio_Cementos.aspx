<%@ Page Language="C#" MasterPageFile="~/Pages/Modulos/Operativo/Reports/MasterPage/design/MasterPage2.master"
 AutoEventWireup="true" CodeBehind="Report_Precio_Cementos.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.Report_Precio_Cementos" %>
    ...
    <asp:UpdatePanel ID="UpReportFotografico" runat="server">
        <ContentTemplate>
         <div align="center">
            ...
            <legend> Consultar Reporte Precio</legend>
           ...
           <td><asp:DropDownList ID="cmbmarca" runat="server" Height="25px" Width="275px" 
                   ...
                   onselectedindexchanged="cmbmarca_SelectedIndexChanged">
                         ...
                         <tr>
           <td  align="right">Tipo PDV :</td>
           <td><asp:DropDownList ID="cmbTipoPDV" runat="server"  Height="25px" Width="275px"
                            >
                        </asp:DropDownList></td>
           ...
           <td><asp:DropDownList ID="cmbciudad" runat="server"  Height="25px" Width="275px" 
                   onselectedindexchanged="cmbciudad_SelectedIndexChanged" AutoPostBack="True"
                            >
                        </asp:DropDownList></td>
                ...
                <telerik:RadGrid ID="gv_Foto" runat="server" AutoGenerateColumns="False" PageSize="2000"
                    ...
                    <MasterTableView NoMasterRecordsText="Sin Datos para mostrar." ForeColor="#00579E"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="ClientPDV_Code" HeaderText="Código PDV" UniqueName="ClientPDV_Code"
                                ReadOnly="true">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="Product_Category" HeaderText="Categoría"
                                UniqueName="Product_Category" ReadOnly="true">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="Name_Brand" HeaderText="Marca" UniqueName="Name_Brand" ReadOnly="true">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="Product_Name" HeaderText="Tipo  de Cemento" UniqueName="Product_Name"
                                ReadOnly="true">
                            </telerik:GridBoundColumn>
                             <telerik:GridBoundColumn DataField="Precio_Fabrica" HeaderText="P. Fábrica" UniqueName="Precio_Fabrica"
                                >
                            </telerik:GridBoundColumn>
                             <telerik:GridBoundColumn DataField="Precio_Lista" HeaderText="P. Almacén" UniqueName="Precio_Lista"
                                >
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="Precio_Oferta" HeaderText="P.  Fv" UniqueName="Precio_Oferta"
                                >
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="Precio_Ferreteria" HeaderText="P. Ferretería" UniqueName="Precio_Ferreteria"
                                >
                            </telerik:GridBoundColumn>
                             <telerik:GridBoundColumn DataField="Precio_Publico" HeaderText="P. Público" UniqueName="Precio_Publico"
                                >
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="Fec_Reg_Bd" HeaderText="Fecha de registro" UniqueName="Fec_Reg_Bd"
                                ReadOnly="true">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Validado" UniqueName="TemplateColumn" ReadOnly="true">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblId_Reg_PrecioDetalle" runat="server" Text='<%# Bind("Id") %>' Visible="false"></asp:Label>
                                     <asp:Label ID="lblId_Reg_Precio" runat="server" Text='<%# Bind("Id_Reg_Precio") %>' Visible="false"></asp:Label>
