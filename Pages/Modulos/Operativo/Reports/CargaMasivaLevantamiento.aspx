<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CargaMasivaLevantamiento.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.CargaMasivaLevantamiento" %>
            ...
            <div>
                ...
                <table align="center">
                    <tr>
                     ...
                     <tr>
                        <td>
                            <asp:Label ID="lblplanning" runat="server" Text="Campaña* " Visible="false"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="cmbplanning" runat="server"  Enabled="False"
                                Height="20px"  Width="300px"   AutoPostBack="True"  Visible="false">
                            </asp:DropDownList>
                        </td>
                    </tr>           
                </table>
