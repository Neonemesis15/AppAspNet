...
{
    public partial class Rpt_Inicio_Fin : System.Web.UI.Page
    {
        ...
        {
            cargarGrilla_Informe();
        }
        protected void cargarGrilla_Informe()
        {
            try
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        Rptsegnv.ServerReport.ReportPath = "/Reporte_Precios_V1/Inicio_Fin_dia";
                        ...
                        parametros.Add(new Microsoft.Reporting.WebForms.ReportParameter("PLANNING", sidplanning));
                       ...
                       // parametros.Add(new Microsoft.Reporting.WebForms.ReportParameter("cod_Product", scodproducto));
                        parametros.Add(new Microsoft.Reporting.WebForms.ReportParameter("FECHA_INI", Convert.ToString(dfecha_inicio)));
                        parametros.Add(new Microsoft.Reporting.WebForms.ReportParameter("FECHA_FIN", Convert.ToString(dfecha_fin)));
                        parametros.Add(new Microsoft.Reporting.WebForms.ReportParameter("CLIENTE", Convert.ToString(compañia)));
