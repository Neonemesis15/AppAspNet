<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LevantamientoExhImpuls.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.LevantamientoExhImpuls" %>
...
<head runat="server">
    <title>Levantamiento de Exhibiciones e Impulso</title>
                 ...
                 <table align="center">
                           <br />
                            <br />                             
                                <tr>
                                    <td>
                                        <asp:Label ID="Label1" runat="server" Text="Levantamiento de Exhibiciones e Impulso"></asp:Label>
                                    </td>
                                </tr>
                            </table>
...
>
                                               ...
                                               <asp:GridView ID="GvLPublicaciones" runat="server" AutoGenerateColumns="False" 
                                                ...
                                                <Columns>
                                                 <asp:TemplateField HeaderText="codregistro"  Visible="false">
                                                        <EditItemTemplate>
                                                             <asp:label ID="lblcodregistro" runat="server" Width="250px"   Text='<%# Bind("id_exhbiImpl") %>'>       
                                                            </asp:label>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="SKU"  Visible="false">
                                                        <EditItemTemplate>
                                                             <asp:DropDownList ID="cmbsku" runat="server" Width="280px"   Text='<%# Bind("SKU") %>'>       
                                                            </asp:DropDownList>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                   ...
                                                   <asp:TemplateField HeaderText="Inicio Actividad">    
                                                    ...
                                                    <EditItemTemplate>
                                                     ...
                                                     <asp:TemplateField HeaderText="PDV">
                                                      ...
                                                      <asp:TemplateField HeaderText="Tipo Actividad">
                                                          <EditItemTemplate>                                                   
                                                           <asp:DropDownList ID="cmbTipo" runat="server" Width="150px" Text='<%# Bind("id_Tipo_Act") %>' >       
                                                            </asp:DropDownList>
                                                              </EditItemTemplate>
                                                       <ItemTemplate>
                              ...
                              <asp:Panel ID="BuscarLevaP" runat="server" CssClass="busqueda"  Style="display: none"
                                ...
                                <table align="center">
                                    <tr>
                                        <td>
                                            <asp:Label ID="LblTituloBuscar" runat="server" CssClass="labelsTit2" Text="Buscar Levantamiento Exhi. e Impulso" />
                                        </td>
                                    </tr>
                                </table>
                                <br />
