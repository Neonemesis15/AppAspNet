<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LevantamientoPublicaciones.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.LevantamientoPublicaciones" %>
...
<head runat="server">
    <title>Levantamiento de Publicaciones</title>
                 ...
                 <table align="center">
                           <br />
                            <br />                             
                                <tr>
                                    <td>
                                        <asp:Label ID="Label1" runat="server" Text="Levantamiento de Publicaciones"></asp:Label>
                                    </td>
                                </tr>
                            </table>
...
>
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        <td>
                                                            <asp:Label ID="LblRecoger" runat="server" Text="Recoger Por* "></asp:Label>
                                                        </td>
                                                        <td>
                                                           <asp:DropDownList ID="cmbRecoger" runat="server" AutoPostBack="True" Enabled="False"
                                               ...
                                               <asp:GridView ID="GvLPublicaciones" runat="server" AutoGenerateColumns="False" 
                                                ...
                                                <Columns>
                                                 <asp:TemplateField HeaderText="codregistro"  Visible="false">
                                                        <EditItemTemplate>
                                                             <asp:label ID="lblcodregistro" runat="server" Width="250px"   Text='<%# Bind("id_rptePbl") %>'>       
                                                            </asp:label>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="SKU"  Visible="false">
                                                        <EditItemTemplate>
                                                             <asp:DropDownList ID="cmbsku" runat="server" Width="250px"   Text='<%# Bind("SKU") %>'>       
                                                            </asp:DropDownList>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                           <asp:DropDownList ID="cmbsku" runat="server" Width="280px"  >       
                                                            </asp:DropDownList>
                                                        </ItemTemplate>
                                                        <ItemStyle Width="70px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Familia" Visible="false">
                                                        <EditItemTemplate>
                                                        <asp:DropDownList ID="cmbFamilia" runat="server" Width="150px" Text='<%# Bind("id_ProductFamily") %>' >       
                                                            </asp:DropDownList>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                           <asp:DropDownList ID="cmbFamilia" runat="server" Width="280px"  >       
                                                            </asp:DropDownList>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Promoción Puntual">
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="TxtPP" runat="server" Width="150px" Enabled="true" Text='<%# Bind("promocionPuntual") %>'></asp:TextBox>
                                                     </EditItemTemplate>
                                                        <ItemTemplate>
                                                       <asp:TextBox ID="TxtPP" runat="server" Width="120px" Enabled="true" ></asp:TextBox>                                                      
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                     <asp:TemplateField HeaderText="PVP">
                                                          <EditItemTemplate>                                                   
                                                            <asp:TextBox ID="TxtPVP" runat="server" Width="150px" Enabled="true" Text='<%# Bind("PVP") %>'></asp:TextBox>
                                                              </EditItemTemplate>
                                                       <ItemTemplate>
                                                       <asp:TextBox ID="TxtPVP" runat="server" Width="100px" Enabled="true" ></asp:TextBox>                                                                           
                                                       </ItemTemplate>
                                                    </asp:TemplateField> 
                                                     <asp:TemplateField HeaderText="Oferta">
                                                          <EditItemTemplate>                                                   
                                                            <asp:TextBox ID="TxtOferta" runat="server" Width="150px" Enabled="true" Text='<%# Bind("Oferta") %>'></asp:TextBox>
                                                              </EditItemTemplate>
                                                       <ItemTemplate>
                                                     <asp:TextBox ID="TxtOferta" runat="server" Width="100px" Enabled="true" ></asp:TextBox>                                                                           
                                                       </ItemTemplate>
                                                    </asp:TemplateField>   
                                                    ...
                                                    <EditItemTemplate>
                                                     ...
                                                     <asp:TemplateField HeaderText="Cadena">
                                                          <EditItemTemplate>                                                   
                                                             <asp:DropDownList ID="cmbCadena" runat="server" Width="150px" Text='<%# Bind("nodeComercial_id") %>' >       
                                                             </asp:DropDownList>
                                                          </EditItemTemplate>
                                                       <ItemTemplate>
                                                       <asp:DropDownList ID="cmbCadena" runat="server" Width="120px"  >       
                                                            </asp:DropDownList>                                                                               
                                                       </ItemTemplate>
                                                    </asp:TemplateField> 
                                                      <asp:TemplateField HeaderText="Tipo Publicación">
                                                          <EditItemTemplate>                                                   
                                                           <asp:DropDownList ID="cmbTipo" runat="server" Width="150px" Text='<%# Bind("id_tipoPublicacion") %>' >       
                                                            </asp:DropDownList>
                                                              </EditItemTemplate>
                                                       <ItemTemplate>
                                                      <asp:DropDownList ID="cmbTipo" runat="server" Width="120px"  >       
                                                            </asp:DropDownList>                                                                               
                                                       </ItemTemplate>
                                                    </asp:TemplateField>                         
                              ...
                              <asp:Panel ID="BuscarLevaP" runat="server" CssClass="busqueda"  Style="display: none"
                                ...
                                <table align="center">
                                    <tr>
                                        <td>
                                            <asp:Label ID="LblTituloBuscar" runat="server" CssClass="labelsTit2" Text="Buscar Levantamiento Publicaciones" />
                                        </td>
                                    </tr>
                                </table>
                                <br />
                                <table align="center">
                                 ...
                                 <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblBrecogido" runat="server" CssClass="labels" Text="Recogido Por:" />
                                        </td>
                                        <td>
                                            <asp:DropDownList ID="cmbBRecogidoPof" runat="server" MaxLength="50" 
                                                Width="193px">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>                      
