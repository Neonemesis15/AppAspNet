<%@ Page Language="C#" MasterPageFile="~/Pages/Modulos/Operativo/Reports/MasterPage/design/MasterPage2.master" AutoEventWireup="true" CodeBehind="Report_Competencia_Cementos.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.Report_Competencia_Cementos" %>
    ...
    <asp:UpdatePanel ID="UpReportFotografico" runat="server">
        <ContentTemplate>
         <div align="center">
            ...
            <legend  > Consultar Reporte Competencia</legend>
           ...
           <td>
               <asp:DropDownList ID="cmbciudad" runat="server" AutoPostBack="True" 
                   ...
                   Width="275px">
                                     ...
                                     <tr>
           <td  align="right">
               <asp:Label ID="lbl_marca0" runat="server" Text="Categoria : "></asp:Label>
                                         </td>
           <td>
               <asp:DropDownList ID="cmbCategoria" runat="server" Enabled="False" 
           ...
           <td>
               <asp:DropDownList ID="cmbMarca" runat="server" Enabled="False" 
                   Height="25px" Width="275px">
               </asp:DropDownList>
                                         </td>
           <td  align="right">
               <asp:Label ID="Label10" runat="server" Text="Tipo Competencia : "></asp:Label>
                                         </td>
           <td>
               <asp:DropDownList ID="cmbTipoCompetencia" runat="server" Enabled="False" Height="25px" 
                   Width="275px">
               </asp:DropDownList>
                                         </td>
            </tr>
           ...
           <td>
               <asp:DropDownList ID="cmbEmpresa" runat="server" Enabled="False" 
                   Height="25px" Width="275px">
               </asp:DropDownList>
                                         </td>
           <td  align="right">
               <asp:Label ID="Label14" runat="server" Text="Tipo Actividad : "></asp:Label>
                                         </td>
           <td>
               <asp:DropDownList ID="cmdTipoActividad" runat="server" Enabled="False" Height="25px" 
                   Width="275px">
               </asp:DropDownList>
                                         </td>
            </tr>
           ...
           <td>&nbsp;</td>
            ...
            <div id="div_gvFoto" runat="server" aling="center" style="width: 100%; height: auto; overflow:auto" >
                <div align="right">
                    ...
                    <MasterTableView NoMasterRecordsText="Sin Datos para mostrar." ForeColor="#00579E"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="Gestor" HeaderText="Gestor de Inf. y Exh." UniqueName="Gestor"
                             ...
                             <telerik:GridBoundColumn DataField="FEC_COMUNICACION" HeaderText="Fecha de Comunicacion" UniqueName="FEC_COMUNICACION"
                                ReadOnly="true">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="Mecanica" HeaderText="Mecánica" UniqueName="Mecanica">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="POP_name" HeaderText="Material de Apoyo" UniqueName="POP_name"
                                ReadOnly="true">
                            </telerik:GridBoundColumn>
                             <telerik:GridDropDownColumn Visible="false"  HeaderText="Material de Apoyo" UniqueName="ddlPOP">
                            </telerik:GridDropDownColumn>
                            <telerik:GridDateTimeColumn DataField="Fec_Ini_Act" HeaderText="Fecha Inicio" UniqueName="Fec_Ini_Act"
                               PickerType="DateTimePicker" >
                            </telerik:GridDateTimeColumn>
                            <telerik:GridDateTimeColumn DataField="Fec_Fin_Act" HeaderText="Fecha Fin" UniqueName="Fec_Fin_Act"
                               PickerType="DateTimePicker" >
                            </telerik:GridDateTimeColumn>
                            <telerik:GridBoundColumn DataField="Precio_PVP" HeaderText="Precio" UniqueName="Precio_PVP">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Validado" UniqueName="TemplateColumn" ReadOnly="true">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lbl_Id_Reg_Competencia" runat="server" Text='<%# Bind("Id_rcompe") %>' Visible="false"></asp:Label>
                                    <asp:Label ID="lbl_Id_rpde" runat="server" Text='<%# Bind("Id_rcompe") %>' Visible="false"></asp:Label>
                                    <asp:Label ID="lbl_Regdetalle" runat="server" Text='<%# Bind("Id_rpde") %>' Visible="false"></asp:Label>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
