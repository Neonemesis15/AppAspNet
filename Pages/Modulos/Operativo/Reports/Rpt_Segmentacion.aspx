<%@ Page Language="C#" MasterPageFile="~/Pages/Modulos/Operativo/Reports/MasterPage/design/MasterPage2.master"
    AutoEventWireup="true" CodeBehind="Rpt_Segmentacion.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.Rpt_Segmentacion"
...
<%--    <cc1:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" EnableScriptGlobalization="True">
    ...
    <asp:UpdatePanel ID="UpdatePanel_contenido" runat="server">
        <ContentTemplate>
            ...
            <div id="dvsg" runat="server" class=""class_div" style="width: auto; height: auto;">
                <rsweb:ReportViewer ID="Rptsegm" runat="server" Font-Names="Verdana" Font-Size="8pt"
