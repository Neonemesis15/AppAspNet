<%@ Page Language="C#"  MasterPageFile="~/Pages/Modulos/Operativo/Reports/MasterPage/design/MasterPage2.master"  AutoEventWireup="true" CodeBehind="Report_Presencia_Colgate_BODEGA.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.Report_Presencia_Colgate_BODEGA" %>
                ...
                <tr>
                    ...
                    <td class="style6">
                        <asp:DropDownList ID="cmbMalla" runat="server" Enabled="False"
                            ...
                            Width="275px" onselectedindexchanged="cmbMalla_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                        ...
                        <td>
                            <telerik:RadGrid ID="gv_presencia" runat="server" GridLines="None" Skin="Vista" 
                                ...
                                <MasterTableView NoMasterRecordsText="Sin Datos para mostrar." ForeColor="#00579E"
                                    ...
                                    <Columns>
                                        <telerik:GridTemplateColumn UniqueName="TemplateColumn" ReadOnly="true" ItemStyle-Width="100">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lbl_id_cliente" Text='<%#Eval("PDV_Client") %>' runat="server"
                                                    Visible="false"></asp:Label>
                                                <asp:Label ID="lbl_id_node" Text='<%#Eval("nodocomercial") %>' runat="server"
                                                    Visible="false"></asp:Label>
                                                    <asp:Label ID="lbl_fecha" Text='<%#Eval("Fecha") %>' runat="server"
                                                    Visible="false"></asp:Label>
                                                    <asp:Label ID="lbl_id_mercaderista" Text='<%#Eval("id_mercaderista") %>' runat="server"
                                                    Visible="false"></asp:Label>
                                            </ItemTemplate>
