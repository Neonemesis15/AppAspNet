<%@ Page Language="C#" MasterPageFile="~/Pages/Modulos/Operativo/Reports/MasterPage/design/MasterPage2.master"
    AutoEventWireup="true" CodeBehind="Reporte_PopFotos.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.Reporte_Pop.Reporte_PopFotos" %>
        ...
        <asp:UpdatePanel ID="up_dataList" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                <div align="center">
                    ...
                    <asp:DataList ID="DataList_Pop" runat="server" RepeatColumns="3" BackColor="White"
                            ...
                            <table class="style1">
                                ...
                                <tr>
                                    ...
                                    text-decoration: underline" />--%>
                                        ...
                                        <asp:Label ID="lbl_idPopDet" runat="server" Text='<%# Eval("Id_rpPopDet")%>' Visible="false"></asp:Label>
                                    </td>
                                    <td>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="style4">
                                        <asp:Label ID="lbl_popName" runat="server" Text='<%# Eval("POP_name") %>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style3">
                                    ...
                                    <td class="style4">
                                        <asp:Label ID="lbl_tipoPop" runat="server" Text='<%# Eval("TipoMaDescripcion") %>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="etiqueta">
                                    ...
                                    <td class="etiqueta">
                                        Desde
                                        <asp:Label ID="lbl_vigencia" runat="server" Text='<%# Eval("Fecha_ini") %>'></asp:Label>
                                        <br />
                                        hasta
                                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("Fecha_fin") %>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style4">
                                        <b style="text-align: left">Comentario </b>
                                    </td>
                                    <td class="style4">
                                        <asp:Label ID="lbl_comentario" runat="server" Text='<%# Eval("Comentario") %>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style4">
