<%@ Page Language="C#" MasterPageFile="~/Pages/Modulos/Operativo/Reports/MasterPage/design/MasterPage2.master"
    AutoEventWireup="true" CodeBehind="Reporte_Promocion.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.Reporte_Promocion.Reporte_Promocion" %>
        ...
        <asp:UpdatePanel ID="up_dataList" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                <div align="center">
                    ...
                    <asp:DataList ID="DataList_Prom" runat="server" RepeatColumns="3" BackColor="White"
                            ...
                            <table class="style1">
                                ...
                                <tr>
                                    ...
                                    text-decoration: underline" />--%>
                                        <asp:CheckBox ID="cb_validar" runat="server" Text="Validar" Checked='<%# Eval("Validado")%>'
                                            Style="font-weight: 700; text-decoration: underline" />
                                        <asp:HiddenField ID="hf_idPopDet" runat="server" Value='<%# Eval("id_rpPromocion") %>' />
                                    </td>
                                    <td>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="style4">
                                        <asp:Label ID="lbl_promName" runat="server" Text='<%# Eval("nombre") %>' 
                                ...
                                <tr>
                                    <td class="etiqueta">
                                        <b style="text-align: left">Vigencia </b>
                                    </td>
                                    <td class="etiqueta">
                                        Desde
                                        <asp:Label ID="lbl_vigencia" runat="server" Text='<%# Eval("Fec_ini_promocion") %>'></asp:Label>
                                        <br />
                                        hasta
                                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("Fec_fin_promocion") %>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style4">
                                        <b style="text-align: left">Precio Promocional </b>
                                    </td>
                                    <td class="style4">
                                        <asp:Label ID="lbl_precProm" runat="server" Text='<%# Eval("precio_promocion") %>'></asp:Label>
                                    </td>
                                </tr>
                                 <tr>
                                    <td class="style4">
                                        <b style="text-align: left">Precio Regular </b>
                                    </td>
                                    <td class="style4">
                                        <asp:Label ID="lbl_precRegular" runat="server" Text='<%# Eval("precio_regular") %>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style4">
