...
{
    public partial class Report_Ingresos_Stock_SF_M_DailySales : System.Web.UI.Page
    {
        ...
        protected void cargarGrilla_Stock_Ingresos()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    dt = Ocoon.ejecutarDataTable("UP_WEBXPLORA_OPE_CONSULTA_STOCK_INGRESOS_SF_MODERNO", dfecha_inicio, dfecha_fin, sidplanning, sidchannel, iidcorporacion, icod_oficina, iidNodeComercial, sidPDV, sidcategoriaProducto, sidmarca, iidperson);


                    //******Modificado por: Pablo Salas*****///
                    //******Fecha:12/09/2011******////
                    //******Resumen:Muestra el Reporte de Stock-Ingresos, los valores de ingreso y stock final dentro de un rango de fechas, (No calcula ninguna venta)
                    //dt = Ocoon.ejecutarDataTable("UP_WEBXPLORA_OPE_CONSULTA_STOCK_INGRESOS_SF_MODERNO_ALL_FIELDS", dfecha_inicio, dfecha_fin, sidplanning, sidchannel, iidcorporacion, icod_oficina, iidNodeComercial, sidPDV, sidcategoriaProducto, sidmarca, iidperson);
