...
AutoEventWireup="true" CodeBehind="Report_SF_Tra_TrabTda_Consolidado.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.Report_SF_Tra_TrabTda_Consolidado" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel_contenido" runat="server">
        <ContentTemplate>
            ...
            <div align="center">
                ...
                <tr>
                    <td class="style3" >
                        REPORTE TRABAJO DE TIENDA - SAN FERNANDO - TRADICIONAL
                    </td>
                </tr>
            </table>
                <fieldset    style="width:850px"  >
                        <legend  > Consultar Reporte de Trabajo de Tienda </legend>
                         <table>
                            <tr>
                                <td  align="right">
                                    Fecha de Inicio:
