...
{
    public partial class Reporte_Competencia_SF_M_V_1_1 : System.Web.UI.Page
    {
        ...
        #endregion
        #region Evento SelectedIndexChanged para el Cmb_Canal
        ...
        protected void cmbplanning_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cmbplanning.SelectedIndex != 0)
            {
                ...
                //Se agrega los nuevos filtros solicitados
                cmbTipoActividad.Items.Clear();
                cmbTipoActividad.Enabled = true;
                cmbempresa_competidora.Items.Clear();
                cmbempresa_competidora.Enabled = true;
                cmbGrupoObjetivo.Items.Clear();
                cmbGrupoObjetivo.Enabled = true;
                ...
                cargarCombo_empresaCompetidora(sidplanning);
                cargarCombo_tipoActividad(sidplanning);
                cargarCombo_GrupoObjetivo(sidplanning, sidchannel);
                //----------------------------------------------------
            }
            else
            {
                ...
                cmbempresa_competidora.Items.Clear();
                cmbempresa_competidora.Enabled = false;
                cmbGrupoObjetivo.Items.Clear();
                cmbGrupoObjetivo.Enabled = false;
        ...
        protected void cargarCombo_empresaCompetidora(string sid_planning)
        {
            ...
            //UP_WEBXPLORA_AD_OBTENER_CORPORACION_BY_idPlanning
            Conexion Ocoon = new Conexion();
            dt = Ocoon.ejecutarDataTable("UP_WEBXPLORA_OPE_COMBO_EMPRESA_COMPETIDORA_REPORT_COMPETENCIA", sid_planning);
            if (dt.Rows.Count > 0)
            {
                cmbempresa_competidora.DataSource = dt;
                cmbempresa_competidora.DataValueField = "ID_EMPRESA";
                cmbempresa_competidora.DataTextField = "Company_Name";
                cmbempresa_competidora.DataBind();
                cmbempresa_competidora.Items.Insert(0, new ListItem("---Todas---", "0"));
            }

        }
        protected void cargarCombo_tipoActividad(string sid_planning)
        {
            ...
            //UP_WEBXPLORA_AD_OBTENER_CORPORACION_BY_idPlanning
            Conexion Ocoon = new Conexion();
            dt = Ocoon.ejecutarDataTable("UP_WEBXPLORA_OPE_COMBO_TIPO_ACTIVIDAD_REPORT_COMPETENCIA", sid_planning);
            if (dt.Rows.Count > 0)
            {
                cmbTipoActividad.DataSource = dt;
                cmbTipoActividad.DataValueField = "Id_Tipo_Act";
                cmbTipoActividad.DataTextField = "descripcion";
                cmbTipoActividad.DataBind();
                cmbTipoActividad.Items.Insert(0, new ListItem("---Todas---", "0"));
            }

        }
        protected void cargarCombo_GrupoObjetivo(string sid_planning, int cod_channel)
        {
            ...
            //UP_WEBXPLORA_AD_OBTENER_CORPORACION_BY_idPlanning
            Conexion Ocoon = new Conexion();
            dt = Ocoon.ejecutarDataTable("UP_WEBXPLORA_OPE_COMBO_GRUPO_OBJETIVO_REPORT_COMPETENCIA", sid_planning, cod_channel);
            if (dt.Rows.Count > 0)
            {
                cmbGrupoObjetivo.DataSource = dt;
                cmbGrupoObjetivo.DataValueField = "Id_Grupo_obj";
                cmbGrupoObjetivo.DataTextField = "TargetGroup";
                cmbGrupoObjetivo.DataBind();
                cmbGrupoObjetivo.Items.Insert(0, new ListItem("---Todas---", "0"));
            }
        ...
        /*Evento selectedIndex para el ddl Canal*/
        ...
        /*Evento paracargar el nodoComercial*/
        ...
        /*Evento para cargar la Categoria*/
        ...
        /*Metodo para limpiar todos los Dropdownlist*/
        public void Limpiar()
        {
        ...
        /*Evento cuando se selecciona la Campaña*/
        ...
        /*Evento SelectedIndex para Oficina*/
        ...
        /*Evento SelectedIndex para NodoComercial*/
        ...
        /*Evento SelectedIndex para Categoria*/
        ...
        /*Evento GuardarReporte de Competencia, actualmente no se usa (comprobar)*/
        ...
        /*Evento para SelectedIndex para la Corporación*/
        ...
        //metodo para cargar la grilla en el radTelerikGridView trae unicamente datos no imagen
        private void cargar_rgv_competencia()
        {
            try
            {
                ...
                string iitargetGroup = cmbGrupoObjetivo.SelectedValue;
                if (iitargetGroup == "")
                    iitargetGroup = "0";

                string iiempresaCompetidora = cmbempresa_competidora.SelectedValue;
                if(iiempresaCompetidora=="")
                    iiempresaCompetidora="0";

                string iitipoActividad = cmbTipoActividad.SelectedValue;
                if (iitipoActividad == "")
                    iitipoActividad = "0";
        ...
        /*  Metodo para seleccionar todas las casillas de verificación   */
        ...
        #endregion
        /*  Metodo para Guardar la Nueva Foto    */
        ...
        protected void btn_validar_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < rgv_competencia.Items.Count; i++)
            {
                GridItem item = rgv_competencia.Items[i];
                ...
                Label lbl_Id_regcompetencia = (Label)item.FindControl("lbl_id_reg_competencia");


                int id = Convert.ToInt32(lbl_Id_regcompetencia.Text);
                bool validar = cb_validar.Checked;
                update_competencia_detalle_validado(id, validar);
                if (validar == true)
                {
            ...
            //    update_competencia_detalle_validado(iid_Cabz_compet, validar);
      ...
      /*  Metodo para los CheckBoxs    */
       ...
       /*  Metodo para Cargar las imagenes     */
        ...
        /* Evento del Boton para Actualizar la foto que se ve en línea  */
        ...
        /*         Método para Activar el Progress Bar Mientras Carga la Imagen         */
        ...
        /*Evento para cancelar Actualizar la imagen */
        ...
        /*Editar el Reporte de Competencia*/
        ...
        /*Actualizar el Reporte de Competencia*/
        protected void rgv_competencia_UpdateCommand(object source, GridCommandEventArgs e)
        {
            try
            {
                ...
                string promocionini = ArrayEditorValue[0].ToString();
                string promocionfin = ArrayEditorValue[1].ToString();
                */

                DateTime promocionini = Convert.ToDateTime((ArrayEditorValue[0] as RadDatePicker).SelectedDate);
                DateTime promocionfin = Convert.ToDateTime((ArrayEditorValue[1] as RadDatePicker).SelectedDate);
                string precioregular = ArrayEditorValue[2].ToString();
                string preciooferta = ArrayEditorValue[3].ToString();
                DateTime fec_reg_bd = Convert.ToDateTime((ArrayEditorValue[4] as RadDatePicker).SelectedDate);


                string strpromocionini = Convert.ToString(promocionini);
                string strpromocionfin = Convert.ToString(promocionfin);
                //string str_Fec_reg_bd = Convert.ToString(fec_reg_bd);

                Ocoon.ejecutarDataReader("UP_WEBXPLORA_OPE_ACTUALIZAR_REPORTE_COMPETENCIA_SF_MODERNO", iid_regcompetencia, precioregular, preciooferta, strpromocionini, strpromocionfin, Session["sUser"].ToString(), DateTime.Now, ckvalidado.Checked, fec_reg_bd);
                cargar_rgv_competencia();
                ...
                //    Ocoon.ejecutarDataReader("UP_WEBXPLORA_OPE_ACTUALIZAR_REPORTE_COMPETENCIA", iid_Cabz_compet, tipoReg, Precio_Costo, Precio_PVP, Fec_Ini_Act, Fec_Fin_Act, Cant_Personal, Premio, Mecanica, Txt_Grupo_Obj, Mat_Apoyo, fec_reg, Session["sUser"].ToString(), DateTime.Now, observaciones, cb_validar.Checked);
        ...
        /*Cancelar el Reporte de Competencia*/
        ...
        /*Evento para modificar el numero de elementos que muestra la grilla*/
        ...
        /*Evento para cerrar el PopPup de Actualizar la Foto
         Pequeña imagen que se muestra en la parte superior derecha
         */
