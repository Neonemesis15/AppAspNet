...
{
    public partial class Report_Precios_SF_M : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //RadGrid gv_precios = new RadGrid();
            //gv_precios.ClientSettings.Scrolling.AllowScroll = true;
            //gv_precios.ClientSettings.Scrolling.UseStaticHeaders = true;
        ...
        protected void cargarGrilla_Precio()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    dt = Ocoon.ejecutarDataTable("UP_WEBXPLORA_OPE_CONSULTA_PRECIO_SF_MODERNO2", sidchannel, sidplanning, sidcorporacion, icod_oficina, iidNodeComercial, sidPDV, sidcategoriaProducto, sidmarca, dfecha_inicio, dfecha_fin, iidperson);
        ...
        protected void cargarGrilla_Precio_To_Excel()
        {
            lblmensaje.Text = "";
            try
            {
                ...
                else
                {
                    ...
                    dt = Ocoon.ejecutarDataTable("UP_WEBXPLORA_OPE_CONSULTA_PRECIO_SF_MODERNO2_TO_EXCEL", sidchannel, sidplanning, sidcorporacion, icod_oficina, iidNodeComercial, sidPDV, sidcategoriaProducto, sidmarca, dfecha_inicio, dfecha_fin, iidperson);
        ...
        protected void gv_precios_UpdateCommand(object source, GridCommandEventArgs e)
        {
            try
            {
                ...
                string precio_regular = ArrayEditorValue[0].ToString();
                string precio_oferta = ArrayEditorValue[1].ToString();
                DateTime Fec_reg_bd = Convert.ToDateTime((ArrayEditorValue[2] as RadDateTimePicker).SelectedDate);

                Ocoon.ejecutarDataReader("UP_WEBXPLORA_OPE_ACTUALIZAR_REPORTE_PRECIO_SANFERNDO_MODERNO", iid_det_prec, precio_regular, precio_oferta, Fec_reg_bd, Session["sUser"].ToString(), DateTime.Now, ckvalidado.Checked);
