...
<asp:Content ID="SheetContent" ContentPlaceHolderID="SheetContentPlaceHolder" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel_contenido" runat="server">
        <ContentTemplate>
            ...
            <div style="width: 800px; margin: auto">
                <div class="style3" style="margin: auto">REPORTE DE PRECIOS</div>
                <fieldset style="width: 800px">
                    ...
                    <div class="centrarcontenido" style="margin: auto; align-content: center; border: 1px; width: 630px;">
                            ...
                            <table style="width: 580px; height: auto; margin:auto;">
                                <tr>
                                    ...
                                    <td><telerik:RadDateTimePicker ID="txt_fecha_inicio" runat="server" Culture="es-PE" Skin="Web20">
                                            <TimeView CellSpacing="-1" Culture="es-PE" HeaderText="Hora"></TimeView>
                                            <TimePopupButton HoverImageUrl="" ImageUrl="" />
                                            <Calendar Skin="Web20" UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False" ViewSelectorText="x"></Calendar>
                        ...
                        <fieldset style="width: 600px">
                            ...
                            <tr>
                                ...
                                <td class="style12">
                                    <asp:DropDownList ID="cmbcanal" runat="server" AutoPostBack="True" Font-Bold="False" 
                                        Font-Italic="False" Height="25px" OnSelectedIndexChanged="cmbcanal_SelectedIndexChanged" 
                                        Width="150px">
                                    </asp:DropDownList>
                                </td>            
                                ...
                                <td class="style12">
                                    <asp:DropDownList ID="cmbplanning" runat="server" AutoPostBack="True" Enabled="False" 
                                        Height="25px" OnSelectedIndexChanged="cmbplanning_SelectedIndexChanged" 
                                        Width="150px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        ...
                        <fieldset style="width: 600px">
                            ...
                            <table style="width: 580px; height: auto; margin:auto;">
                                <tr>
                                    ...
                                    <td class="style12">
                                        <asp:DropDownList ID="cmbperson" runat="server" Enabled="False" Height="25px" Width="150px">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    ...
                                    <td class="style12">
                                        <asp:DropDownList ID="cmbOficina" runat="server" AutoPostBack="true" 
                                            Enabled="False" Height="25px" OnSelectedIndexChanged="cmbOficina_SelectedIndexChanged" 
                                            Width="150px"> 
                                        </asp:DropDownList>
                                    </td>
                                    <td class="style17">Zona :</td>
                                        <td class="style12">
                                            <asp:DropDownList ID="cmbNodeComercial" runat="server" AutoPostBack="true" Enabled="False" 
                                                Height="25px" OnSelectedIndexChanged="cmbNodeComercial_SelectedIndexChanged" Width="150px">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <fieldset style="width: 600px">
                            ...
                            <table style="width: 580px; height: auto; margin:auto;">
                                <tr>
                                    ...
                                    <td class="style12">
                                        <asp:DropDownList ID="cmbsubcategoria" runat="server" AutoPostBack="True" Enabled="False" Height="25px" 
                                            Width="150px">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="style12">
                                        <asp:DropDownList ID="cmbmarca" runat="server" AutoPostBack="True" Enabled="False" Height="25px" 
                                            OnSelectedIndexChanged="cmbmarca_SelectedIndexChanged" Width="150px">
                                        </asp:DropDownList>
                                    </td>
                                    <td class="style17">SKU :</td>
                                    <td class="style12">
                                        <asp:DropDownList ID="cmbsku" runat="server" Enabled="False" Height="25px" Width="150px">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div class="centrarcontenido" style="margin-bottom:10px; margin-top:10px">
                        <p>
                            <asp:Button ID="BtnCrear" runat="server" CssClass="buttonGreen" Height="25px" OnClick="BtnCrear_Click" 
                                Text="Crear" Width="100px" />
                            <asp:Button ID="BtnCrearMasivo" runat="server" CssClass="buttonGreen" Height="25px" 
                                Text="Carga Masiva" Width="100px" />
                            <asp:Button ID="btn_buscar" runat="server" CssClass="buttonBlue" Height="25px" OnClick="btn_buscar_Click" 
                                Text="Buscar" Width="100px" />
                            <asp:Button ID="btn_exportarexcel" runat="server" CssClass="buttonGreen" Height="25px" 
                                OnClick="btn_exportarexcel_Click" Text="Exportar a Excel" Width="100px" />
                        </p>
                        <p>
                        ...
                        <fieldset style="width: 580px; margin: auto">
                            ...
                            <p>
                                <asp:Button ID="btn_verificar" runat="server" CssClass="botonBlue" Height="25px" 
                                    OnClick="btn_verificar_Click" Text="Precios Cero" Width="164px" Enabled="false" />
                                <asp:Button ID="btn_verfecha" runat="server" CssClass="botonBlue" Height="25px" 
                                    Text="Fuera de Período" Width="164px" OnClick="btn_verfecha_Click" />
            ...
            <div id="div_gvPrecios" runat="server" style="margin:auto; width: 100%; height: auto;" >
                ...
                <!-- -------------------------------------------------------- -->
                <!-- -------------------------------------------------------- -->
                <!-- GRIDVIEW_PRECIOS - INI --> 
                <!-- -------------------------------------------------------- -->
                <!-- -------------------------------------------------------- -->
                <!-- -------------------------------------------------------- -->
                <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderWidth="1px" 
                    CellPadding="3" BorderStyle="None" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" 
                    AutoGenerateColumns="False" AllowSorting="True" OnSorting="GridView1_Sorting" Width="100%" PageSize="100" 
                    OnRowEditing="gv_precios_RowEditing" OnRowCancelingEdit="gv_precios_RowCancelingEdit" 
                    OnRowUpdating="gv_precios_RowUpdating" EnableModelValidation="True">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField Visible="false">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lbl_gvp_precio_pdv" runat="server" Text='<%# Eval("Precio punto de venta")%>' 
                                    Visible="true"></asp:Label>
                                <telerik:RadNumericTextBox ID="txt_gvp_precio_pdv" runat="server" Visible="false" ShowSpinButtons="True" 
                                    NumberFormat-DecimalDigits="2" Height="20px" Skin="Telerik" Width="112px" Culture="es-PE" MinValue="0" 
                                    ToolTip="Precio de PDV" EmptyMessage="vacio">
                        ...
                        <asp:TemplateField Visible="false">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lbl_gvp_precio_oferta" runat="server" Text='<%# Eval("Precio de oferta")%>' 
                                    Visible="true"></asp:Label>
                                <telerik:RadNumericTextBox ID="txt_gvp_precio_oferta" runat="server" Visible="false" 
                                    ShowSpinButtons="True" NumberFormat-DecimalDigits="2" Height="20px" Skin="Telerik" Width="112px" 
                                    Culture="es-PE" MinValue="0" ToolTip="Precio Oferta" EmptyMessage="vacio">
                                </telerik:RadNumericTextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <%-- --------------------------------------------------------------------- --%>
                        ...
                        <asp:TemplateField Visible="false">
                            ...
                            <ItemTemplate>
                                ...
                                <telerik:RadNumericTextBox ID="txt_gvp_precio_lista" runat="server" Visible="false" 
                                    NumberFormat-DecimalDigits="2" Height="20px" Skin="Telerik" Width="112px" Culture="es-PE" 
                                    ShowSpinButtons="true" MinValue="0" ToolTip="Precio de lista" EmptyMessage="vacio">
                                </telerik:RadNumericTextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField Visible="false">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lbl_gvp_precio_reventa" runat="server" Text='<%# Eval("Precio reventa")%>' 
                                    Visible="true"></asp:Label>
                                <telerik:RadNumericTextBox ID="txt_gvp_precio_reventa" runat="server" Visible="false" 
                                    NumberFormat-DecimalDigits="2" Height="20px" Skin="Telerik" Width="112px" Culture="es-PE" 
                                    ShowSpinButtons="true" MinValue="0" ToolTip="Precio reventa" EmptyMessage="vacio">
                                </telerik:RadNumericTextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <%-- --------------------------------------------------------------------- --%>
                        ...
                        <asp:TemplateField Visible="false">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lbl_gvp_precio_costo" runat="server" Text='<%# Eval("Precio costo")%>' 
                                    Visible="true"></asp:Label>
                                <telerik:RadNumericTextBox ID="txt_gvp_precio_costo" runat="server" Visible="false" 
                                    ShowSpinButtons="True" NumberFormat-DecimalDigits="2" Height="20px" Skin="Telerik" Width="112px" 
                                    Culture="es-PE" MinValue="0" ToolTip="Precio costo" EmptyMessage="vacio">
                                </telerik:RadNumericTextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <%-- --------------------------------------------------------------------- --%>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                ...
                                <telerik:RadDateTimePicker ID="RadDateTimePicker_fec_reg" runat="server" Visible="False" 
                                    DateInput-EmptyMessage="Fecha" TimePopupButton-ToolTip="Mostrar hora." 
                                    DatePopupButton-ToolTip="Mostrar fecha." TimeView-Culture="es-PE" TimeView-Interval="00:20:00" 
                                    Culture="es-PE" Skin="Outlook" EnableTyping="false">
                        ...
                        <asp:TemplateField>
                            <HeaderTemplate>
                                <asp:Button ID="btn_validar" runat="server" OnClick="btn_validar_Click" Text="Invalidar" 
                                    OnClientClick="return confirm('¿Esta seguro de invalidar los registros?');" /> <br/>
                        ...
                        <asp:CommandField ShowEditButton="True" EditImageUrl="~/Pages/images/edit_icon.gif" ButtonType="Image" 
                            CancelImageUrl="~/Pages/images/cancel_edit_icon.png" UpdateImageUrl="~/Pages/images/save_icon.png" />
                    </Columns>
                ...
                <!-- -------------------------------------------------------- -->
                <!-- -------------------------------------------------------- -->
                <!-- GRIDVIEW_PRECIOS_V2 - INI --> 
                <!-- -------------------------------------------------------- -->
                <!-- -------------------------------------------------------- -->
                <!-- -------------------------------------------------------- -->
                <asp:GridView ID="gvReportePrecio" runat="server" AutoGenerateColumns="false" CssClass="Grid" 
                    DataKeyNames="repPrecioCod" OnRowDataBound="OnRowDataBound" >
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <img alt = "" style="cursor: pointer" src="images/plus.png" />
                                <asp:Panel ID="pnlDetails" runat="server" Style="display: none">
                                    <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="false" CssClass = "ChildGrid" EditIndex="-1">
                                        <Columns>
                                            <asp:BoundField DataField="Id" HeaderText="#" />
                                            <asp:BoundField DataField="Category_Name" HeaderText="Categoria" />
                                            <asp:BoundField DataField="Brand_Name" HeaderText="Marca" />
                                            <asp:BoundField DataField="Id_Producto" HeaderText="SKU" />
                                            <asp:BoundField DataField="Product_Name" HeaderText="Producto" />
                                            <asp:BoundField DataField="Precio_Lista" HeaderText="P. Lista" />
                                            <asp:BoundField DataField="Precio_Reventa" HeaderText="P. Reventa" />
                                            <asp:BoundField DataField="Precio_Oferta" HeaderText="P. Oferta" />
                                            <asp:BoundField DataField="Precio_PVP" HeaderText="P. P.V.P." />
                                            <asp:BoundField DataField="Precio_Costo" HeaderText="P. Costo" />
                                            <asp:BoundField DataField="Precio_Regular" HeaderText="P. Regular" />
                                            <asp:BoundField DataField="Precio_Min" HeaderText="P. Min." />
                                            <asp:BoundField DataField="Precio_Max" HeaderText="P. Max." />
                                            <asp:BoundField DataField="Validado" HeaderText="Status" />
                                            <asp:BoundField DataField="CreateBy" HeaderText="Creado Por:" />
                                            <asp:BoundField DataField="DateBy" HeaderText="Fec. Creacion:" />
                                            <asp:BoundField DataField="ModiBy" HeaderText="Modificado Por:" />
                                            <asp:BoundField DataField="DateModiBy" HeaderText="Fec. Modificacion:" />
                                        </Columns>
                                    </asp:GridView>
                                </asp:Panel>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField ItemStyle-Width="025px" DataField="rowNumber" HeaderText="#" />
                        <asp:BoundField ItemStyle-Width="141px" DataField="oficinaName" HeaderText="Oficina" />
                        <asp:BoundField ItemStyle-Width="346px" DataField="ptoVentaCode" HeaderText="Cod. Pto. de Venta" />
                        <asp:BoundField ItemStyle-Width="346px" DataField="ptoVentaName" HeaderText="Pto. de Venta" />
                        <asp:BoundField ItemStyle-Width="195px" DataField="fecReg" HeaderText="Fecha" />
                        <asp:BoundField ItemStyle-Width="189px" DataField="cantReg" HeaderText="# Detalles" />
                    </Columns>
                </asp:GridView>
                <!-- -------------------------------------------------------- -->
                <!-- -------------------------------------------------------- -->
                <!-- -------------------------------------------------------- -->
                <!-- GRIDVIEW_PRECIOS_V2 - FIN --> 
                <!-- -------------------------------------------------------- -->
                <!-- -------------------------------------------------------- -->
                <!-- -------------------------------------------------------- -->
                ...
                <!-- -------------------------------------------------------- -->
                <!-- -------------------------------------------------------- -->
                <!-- GRIDVIEW_EXPORTA_EXCEL- INI --> 
                <!-- -------------------------------------------------------- -->
                <!-- -------------------------------------------------------- -->
                <!-- -------------------------------------------------------- -->
                <asp:GridView ID="dgv_faltantes" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderWidth="1px" 
                    CellPadding="3" BorderStyle="None" AutoGenerateColumns="False" Width="100%" EnableModelValidation="True" 
                    Visible="false" CssClass="centrar">
                    <HeaderStyle CssClass="GridHeader" />
                    <RowStyle CssClass="GridRow" />
                    <AlternatingRowStyle CssClass="GridAlternateRow" />
                    <Columns>
            ...
            <!-- -------------------------------------------------------- -->
            <!-- -------------------------------------------------------- -->
            <!-- REGISTRAR_REPORTE_PRECIO - FIN --> 
            <!-- -------------------------------------------------------- -->
            <!-- -------------------------------------------------------- -->
            <!-- -------------------------------------------------------- -->


            <cc1:ModalPopupExtender ID="MopoReporPrecio" runat="server" BackgroundCssClass="modalBackground" DropShadow="True" 
                Enabled="True" OkControlID="btnCancelar" PopupControlID="CrearReporPrecio" TargetControlID="BtnCrear" 
                DynamicServicePath=""> 
            ...
            <!-- -------------------------------------------------------- -->
            <!-- -------------------------------------------------------- -->
            <!-- REGISTRAR_REPORTE_PRECIO_EXCEL - INI --> 
            <!-- -------------------------------------------------------- -->
            <!-- -------------------------------------------------------- -->
            <!-- -------------------------------------------------------- -->
            <asp:Panel ID="CrearReporPrecioMasiva" runat="server" CssClass="busqueda" DefaultButton="btnGuardarReportPrecio" 
                ...
                <table align="center">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlCanalCargaMasiva" runat="server" Width="205px" AutoPostBack="True" 
                                onselectedindexchanged="ddlCanalCargaMasiva_SelectedIndexChanged"></asp:DropDownList>
                        </td>
                    ...
                    <tr>
                        ...
                        <td><asp:DropDownList runat="server"  Width="205px" ID="ddlCampañaCargaMasiva" AutoPostBack="true" 
                            onselectedindexchanged="ddlCampañaCargaMasiva_SelectedIndexChanged"></asp:DropDownList></td>
                        <td style="width: 40px;"></td>
                        <td></td>
                        <td>
                            <a class="button" href="../../../formatos/Formato_Masivo_Reporte_Precio.xls">
                                <span>Descargar Formato</span>
                            </a>
                            <a runat="server" visible="false" id="Datos" class="button" 
                                href="~/Pages/Modulos/Operativo/Reports/masivo/DATOS_CARGA_REPORTE_PRECIO.xls">
            ...
            <!-- -------------------------------------------------------- -->
            <!-- -------------------------------------------------------- -->
            <!-- REGISTRAR_REPORTE_PRECIO_EXCEL - FIN --> 
            <!-- -------------------------------------------------------- -->
            <!-- -------------------------------------------------------- -->
            <!-- -------------------------------------------------------- -->
    ...
    <asp:GridView ID="gv_precioToExcel" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" 
