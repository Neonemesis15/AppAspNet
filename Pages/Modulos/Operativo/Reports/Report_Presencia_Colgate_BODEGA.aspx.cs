...
{
    public partial class Report_Presencia_Colgate_BODEGA : System.Web.UI.Page
    {
        ...
        protected void cargarGrilla_Reporte_Presencia()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ds = Ocoon.ejecutarDataSet("UP_WEBXPLORA_OPE_CONSULTA_PRESENCIA_WITH_PIVOT_BODEGA", compañia, sidplanning, sidchannel, iidmercaderista, icod_oficina, icod_malla, sidPDV, sidTipoReporte, dfecha_inicio, dfecha_fin);
