<%@ Page Language="C#" MasterPageFile="~/Pages/Modulos/Operativo/Reports/MasterPage/design/MasterPage2.master"
    AutoEventWireup="true" CodeBehind="Reporte_Fotografico_New.aspx.cs" Inherits="SIGE.Pages.Modulos.Operativo.Reports.Reporte_Fotografico_New" %>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Foto" UniqueName="TemplateColumn" ReadOnly="true">
                                <ItemTemplate>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="lnkBtn_viewphoto" runat="server" CommandArgument='<%# Bind("Id_repft") %>'
                                                    CommandName="VERFOTO" Font-Underline="True">Ver</asp:LinkButton>
                                            </td>
                                            <td>
                                                <asp:LinkButton ID="lnkBtn_Editphoto" runat="server" Visible="false" CommandArgument='<%# Bind("Id_repft") %>'
                                                    CommandName="EDITFOTO" Font-Underline="True">Cambiar_Foto</asp:LinkButton>
                                            </td>
                                        </tr>
                                    </table>
                                    <asp:Label ID="lbl_id_reg_foto" runat="server" Text='<%# Bind("Id_repft") %>' Visible="False"></asp:Label>
                                    <asp:Image runat="server" ID="RadBinaryImage_foto" Width="110px"  Height="90px" ImageUrl='<%# Bind("Foto") %>' AlternateText="xD" />
                                    <%--<asp:Image  runat="server" Width="110px" Height="90px"
            ...
            <div>
                ...
                <asp:Panel ID="panel_viewfoto" runat="server" Style="display: none" BackColor="White"
                    ...
                    <div align="center" style="font-family: verdana; font-size: medium; color: #005DA3;">
                        ...
                        <div align="center">
                            <asp:ImageButton Visible="false" ID="ImageButton3" runat="server" Width="50px" Height="50px" OnClick="ImageButton3_Click"
                                ImageUrl="~/Pages/images/sub_black_rotate_ccw.ico"></asp:ImageButton>
                            <asp:ImageButton Visible="false" ID="ImageButton4" runat="server" Width="50px" Height="50px" ImageUrl="~/Pages/images/sub_black_rotate_cw.ico"
                                OnClick="ImageButton4_Click"></asp:ImageButton>
                            <!--Guardar--><asp:ImageButton Visible="false" ID="ibtnGuardarImagen" runat="server" ImageUrl="~/Pages/images/save_icon.png"
