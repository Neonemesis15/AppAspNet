<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CategoryInsertUserControl.ascx.cs"
    Inherits="SIGE.Pages.Modulos.Administrativo.ProductUserControls.CategoryInsertUserControl" %>
...
<!---------------------------------------------------------------------------->
<!---------------------------------------------------------------------------->
<asp:Button ID="BtnCrearProductType" 
runat="server" 
CssClass="buttonPlan" 
Text="Crear"
Width="95px" />
        ...
        <div class="tabla centrar">
            <fieldset>
                ...
                <div class="fila">
                    ...
                    <div class="celdaLeft">
                        <asp:TextBox ID="TxtCodProductType" 
                        runat="server" 
                        BackColor="#DDDDDD" 
                        ReadOnly="True"
                        Width="190px" 
                ...
                <div class="fila">
                    ...
                    <div class="celdaLeft">
                        <asp:TextBox ID="TxtgroupCategory" 
                        runat="server" 
                        MaxLength="50" 
                        Width="190px" 
                        Enabled="True">
                ...
                <div class="fila">
                    ...
                    <div>
                        <asp:DropDownList ID="cmb_categorias_cliente" 
                        runat="server" 
                        Width="198px" 
                        Enabled="True">
                        </asp:DropDownList>
...
<!---------------------------------------------------------------------------->
<!---------------------------------------------------------------------------->
<cc1:ModalPopupExtender ID="InsertCategoryModalPopupExtender" 
...
<asp:Panel ID="AlertasInsertPanel" 
DropShadow="True" 
runat="server" 
Style="display: none;"
...
<cc1:ModalPopupExtender ID="ModalPopupAlertasInsert" 
runat="server" 
...
<asp:Button ID="BtndisparaalertasInsert" 
runat="server" 
CssClass="alertas" 
Text=""
Visible="true" 
