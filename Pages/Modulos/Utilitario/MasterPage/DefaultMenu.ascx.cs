...
namespace SIGE.Pages.Modulos.Utilitario.MasterPage
{
    public partial class DefaultMenu : System.Web.UI.UserControl
    {
        ...
        protected void cargarMenuReports()
        {
           ...
           // {
                ...
                menuItem1.Text = "Registro de Firmas";
                menuItem1.NavigateUrl = "~/Pages/Modulos/Utilitario/RegistrarFirmas.aspx";//ds.Tables[0].Rows[i][""].ToString();
                ...
                menuItem2.Value = "1";
                menuItem2.Text = "Aplicación Móvil";
                menuItem2.NavigateUrl = "~/Pages/Modulos/Utilitario/DescargarAplicacionMovil.aspx";
                ...
                menuItem3.Text = "Carga Masiva";
                menuItem3.NavigateUrl = "~/Pages/Modulos/Utilitario/Carga_Masiva.aspx";//ds.Tables[0].Rows[i][""].ToString();
                //menuItem.ImageUrl = "~/img/admin_16.png";
        ...
        protected void RadMenu_reportes_ItemClick(object sender, Telerik.Web.UI.RadMenuEventArgs e)
        {
            ...
            if (miItem.Level == 3)
            {
                ...
                string url = "~/Pages/Modulos/Utilitario/RegistrarFirmas.aspx";
            ...
            else if (miItem.Level == 2 && (RadMenu_reportes.SelectedValue.ToString() == "1023" || RadMenu_reportes.SelectedValue.ToString() == "1241"))
            {
                ...
                string url = "~/Pages/Modulos/Utilitario/MasterPage/Default.aspx";
                Response.Redirect(url, true);
            }
        }
